                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.service.delete', $value->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="fa fa-trash-o text-white"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
