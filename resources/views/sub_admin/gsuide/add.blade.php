            ...
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="box">
                            <!-- /.box-header -->
                            <form class="form" action="{{ route('sub_admin.gsuide.store') }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="date"
                                                        ...
                                                        value="{{ old('fld_gsuite_start_date') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select
                                                        ...
                                                        name="fld_gsuite_tenure" onchange="checkDate()"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="date"
                                                        ...
                                                        value="{{ old('fld_gsuite_end_date') }}" id="fld_gsuite_end_date"
                                                        required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text"
                                                        ...
                                                        placeholder="Tax Rate" value="{{ old('fld_tax_percentage') }}"
                                                        required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text"
                                                        ...
                                                        placeholder="Total Amount" value="{{ old('fld_total_amount') }}"
                                                        readonly>
                                                </div>
