            ...
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="box">
                            <!-- /.box-header -->
                            <form class="form" action="{{ route('sub_admin.gsuide.update', $domainhosting->id) }}"
                                    ...
                                    <div class="row">
                                                        ...
                                                        @if ($customers)
                                                            @foreach ($customers as $key => $users)
                                                                <option value="{{ $users->id }}"
                                                                    ...
                                                                    data-cname="{{ $users->fld_company_name }}"@if ($domainhosting->fld_cust_id == $users->id) selected @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text"
                                                        ...
                                                        value="{{ $customer_details->fld_name }}" readonly>
                                                </div>
                                                @error('cname')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="email"
                                                        ...
                                                        value="{{ $customer_details->fld_email }}" readonly>
                                                </div>
                                                @error('cemail')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text"
                                                        ...
                                                        value="{{ $customer_details->fld_company_name }}" readonly>
                                                </div>
                                                @error('ccname')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
										...
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<select class="form-control select2 @error('fld_gsuite_tenure') is-invalid @enderror" name="fld_gsuite_tenure" onchange="checkDate()" id="fld_gsuite_tenure">
													...
													<option value="2" @if ($domainhosting->fld_gsuite_tenure == 2) selected @endif>2</option>
													<option value="3" @if ($domainhosting->fld_gsuite_tenure == 3) selected @endif>3</option>
													<option value="4" @if ($domainhosting->fld_gsuite_tenure == 4) selected @endif>4</option>
													<option value="5" @if ($domainhosting->fld_gsuite_tenure == 5) selected @endif>5</option>
													<option value="6" @if ($domainhosting->fld_gsuite_tenure == 6) selected @endif>6</option>
													<option value="7" @if ($domainhosting->fld_gsuite_tenure == 7) selected @endif>7</option>
													<option value="8" @if ($domainhosting->fld_gsuite_tenure == 8) selected @endif>8</option>
													<option value="9" @if ($domainhosting->fld_gsuite_tenure == 9) selected @endif>9</option>
													<option value="10" @if ($domainhosting->fld_gsuite_tenure == 10) selected @endif>10</option>
													<option value="11" @if ($domainhosting->fld_gsuite_tenure == 11) selected @endif>11</option>
													<option value="12" @if ($domainhosting->fld_gsuite_tenure == 12) selected @endif>12</option>
												</select>
											</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select
                                                        ...
                                                        @for ($y = 1; $y <= 12; $y++)
                                                            <option value="{{ $y }}"
                                                                @if ($domainhosting->fld_gsuite_tenure == $y) selected @endif>
                                                                {{ $y }}</option>
                                                        @endfor
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select
                                                        ...
                                                        @for ($y = 1; $y <= 12; $y++)
                                                            <option value="{{ $y }}"
                                                                @if ($domainhosting->fld_expiry_gsuite_tenure == $y) selected @endif>
                                                                {{ $y }}</option>
                                                        @endfor
                                                    </select>
                                                </div>
										...
										<div class="row" id="dynamicTable">
											<div class="col-12 text-center">
							                    ...
							                    <div class="row mb-3">
							                        <div class="col-md-5">
							                            <input type="email" name="addmore[0][images]" class="form-control" value="{{ $varient->fld_email }}">
							                        </div>
							                        <div class="col-md-3">
							                            <input type="date" name="addmore[0][price]" class="form-control" value="{{ $varient->fld_email_date }}">
							                        </div>
							                        <div class="col-md-2">
							                            <input type="text" name="addmore[0][stock]" class="form-control inputdecimal" value="{{ $varient->fld_email_desc }}">
							                        </div>
							                        @if ($key == 0)
							                    ...
							                    <div class="row mb-3">
							                        <div class="col-md-5">
							                            <input type="email" name="addmore[0][images]" class="form-control" value="">
							                        </div>
							                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text"
                                                        ...
                                                        placeholder="email_count"
                                                        value="{{ $domainhosting->fld_email_count }}">
                                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function addYears(dateStr, years) {
                ...
                var newYear = parseInt(arr[0]) + parseInt(years);
                return newYear + '-' + arr[1] + '-' + arr[2];
            }
