                            ...
                            <tr @if($gsuite_days == 0) style="background: #f6e2f7;" @endif>
                                ...
                                <td>
                                    <p style="display: flex;">
                                        ...
                                        <a href="{{ route('sub_admin.gsuide.edit1', $value->id) }}" type="Edit" class="btn btn-success" style="padding: 4px 12px;margin: 0px 4px;"><i class="ion ion-edit text-white"></i></a>
                                        @endif
                                        @if(in_array('34', $role_section))
                                        <a href="{{ route('sub_admin.gsuide.not.interest', $value->id) }}" data-confirm="Are you Sure Move Not Interest?" title="Not interest" class="delete btn btn-warning" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-unlink text-white"></i></a>
                                        @endif
                                        @if(in_array('33', $role_section))
                                        <a href="{{ route('sub_admin.gsuide.invoice', $value->id) }}" title="Invoice" class="btn btn-dark" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-files text-white"></i></a>
                                        @endif
                                        ...
                                        <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.gsuide.delete', $value->id) }}')" title="Delete" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                        @endif
                                    </p>
                                </td>
                            </tr>
