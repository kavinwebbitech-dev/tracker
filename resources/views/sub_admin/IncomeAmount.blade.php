                                                ...
                                                @foreach ($IncomeAmount as $key => $value)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @endif
                                                            @if (in_array('105', $role_section))
                                                                <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.imcome.amount.delete', $value->id) }}')"
                                                ...
                                                <p style="display: flex;">
                                                    <a onclick="ViewCategoryModel('{{ $cat->id }}')"
                                                        class="btn btn-primary" style="padding: 4px 12px;margin: 4px;"><i
                                                            class="ion ion-edit text-white"></i></a>
                                                   <a href="javascript:void(0);"onclick="deleteProject('{{ route('admin.income.category.delete', $cat->id) }}')"
