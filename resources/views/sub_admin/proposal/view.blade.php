                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    @if (in_array('64', $role_section))
                                        <div class="col-md-3">
                                            <a href="{{ route('sub_admin.proposal.create') }}"
                                                class="btn btn-primary-light btn-sm add_button" style="float: right;">Add
                                                Proposals</a>
                                        </div>
                                    @endif
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (in_array('65', $role_section))
                                                                <a href="{{ route('sub_admin.proposal.edit', $value->id) }}"
                                                                    class="btn btn-primary"
                                                                    style="padding: 4px 12px;margin: 0px 4px;"><i
                                                                        class="ion ion-edit text-white"></i></a>
                                                            @endif
                                                            @if (in_array('63', $role_section))
                                                                <a href="{{ route('sub_admin.proposal.status', $value->id) }}"
                                                                    class="btn btn-success"
                                                                    style="padding: 4px 12px;margin: 0px 4px;"><i
                                                                        class="ti-eye text-white"></i></a>
                                                            @endif
                                                            @if (in_array('66', $role_section))
                                                                <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.proposal.delete', $value->id) }}')"
