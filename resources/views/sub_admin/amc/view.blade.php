            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        ...
                        @if(in_array('38', $role_section))
                        <div class="col-sm-8">
                            <a class="btn btn-primary" href="{{ route('sub_admin.amc.create') }}" style="float: right;">Add New</a>
                        </div>
                        @endif
                    </div>
                            ...
                            <tr @if($gsuite_days == 0) style="background: #f6e2f7;" @endif>
                                ...
                                <td>
                                    <p style="display: flex;">
                                        @if(in_array('39', $role_section))
                                        <a href="{{ route('sub_admin.amc.edit1', $value->id) }}" type="Edit" class="btn btn-success" style="padding: 4px 12px;margin: 0px 4px;"><i class="ion ion-edit text-white"></i></a>
                                        @endif
                                        @if(in_array('42', $role_section))
                                        <a href="{{ route('sub_admin.amc.not.interest', $value->id) }}" data-confirm="Are you Sure Move Not Interest?" title="Not interest" class="delete btn btn-warning" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-unlink text-white"></i></a>
                                        @endif
                                        @if(in_array('41', $role_section))
                                        <a href="{{ route('sub_admin.amc.invoice', $value->id) }}" title="Invoice" class="btn btn-dark" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-files text-white"></i></a>
                                        @endif
                                        @if(in_array('44', $role_section))
                                        ...
                                        @endif
                                        @if(in_array('40', $role_section))
                                        <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.amc.delete', $value->id) }}')" title="Delete" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                        @endif
                                    </p>
                                </td>
                            </tr>
