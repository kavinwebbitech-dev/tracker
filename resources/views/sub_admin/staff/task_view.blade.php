              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                 ...
                 <div class="active tab-pane" id="usertimeline">
                    <div class="row">
                        <form action="{{ route('sub.staff.report') }}" method="post">
                        {{ csrf_field() }}
                    ...
                    <div class="table-responsive">
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key + 1}}</td>
                                <td>{{ $value1->admin_details->name }}</td>
                                ...
                                <td>{{-- <a href="{{ route('task.edit', $value1->id) }}" class="btn btn-primary" style="padding: 4px 12px;margin: 10px 4px;"><i class="ion ion-edit text-white"></i></a> <a href="javascript:void(0);"onclick="deleteProject('{{ route('task.delete', $value1->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a> --}} <a href="{{ route('admin.task.status', $value1->id) }}" class="btn btn-success" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-eye text-white"></i></a><a href="{{ route('sub.staff.recurring.report', $value1->id) }}" class="btn btn-primary" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-download text-white"></i></a></td>
                            </tr>
                            @endforeach
                            @endif
                        </tbody>
