...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.expenses.amount.delete', $value->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 10px 4px;"><i class="ti-trash text-white"></i></a>
        </td>
    </tr>
    @endforeach
    @endif
