          ...
          <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="{{ route('sub_admin.projects.renewal.view') }}" class="btn btn-primary-light btn-sm add_button">View Notification <span style="border-radius: 50px;background: #3762EA;padding: 1px 5px 2px;color: #fff;">{{ $recordCount }}</span></a>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <a href="{{ route('sub_admin.projects.view') }}" style="width: 100%;padding: 10px;font-size: 15px;display: block;margin-bottom: 4px;">Clear x</a>
                        </div>
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-2">
                            <a class="btn btn-success btn-sm" href="{{ route('sub_admin.projects.create') }}" style="    width: 100%;padding: 10px;">Add Projects</a>
                        </div>
                        @endif
                        @if(in_array('53', $role_section))
                        <div class="col-md-2">
                            <a class="btn btn-primary btn-sm" href="{{ route('sub_admin.projects.renewal') }}" style="    width: 100%;padding: 10px">Renewal Projects</a>
                        </div>
                        @endif
                        @if(in_array('54', $role_section))
                        <div class="col-md-2">
                            <a class="btn btn-danger btn-sm" href="{{ route('sub_admin.completed.payment.project') }}" style="width: 100%;padding: 10px">Completed Payment Projects</a>
                        </div>
                        @endif
                        @if(in_array('84', $role_section))
                        <div class="col-md-2">
                            <a class="btn btn-danger btn-sm" href="{{ route('sub_admin.projects.cancel') }}" style="width: 100%;padding: 10px;background: red !important;">Cancel Payment Projects</a>
                        </div>
                        @endif
                    </div>
                    <div class="row">
                    ...
                    <div class="table-responsive">
                      <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr @if($value->status == 6) style="background: #dc3545;" @endif @if($value->refunded == "refunded") style="background: #ff6464;" @endif>
                                <td>{{ $key + 1}}</td>
                                <td>
                                    {{ $value->name }}
                                ...
                                <td>
                                    <p style="display: flex;margin-bottom: 0px;">
                                        ...
                                        @endif
                                        <a onclick="CustomerDetails('{{$value->customer_id}}')" title="Customer Details" class="btn btn-warning" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-user text-white"></i></a>
  ...
  <script type="text/javascript">
    ...
    function text_value_search()
    {
        ...
        if (text_value_search) {
            $.ajax({
                url: "{{ route('sub_admin.projects.search.view') }}",
                type: "POST",
                data: {
    ...
    function CustomerDetails(id) {
        ...
        if (project_id) {
            $.ajax({
                url: "{{ route('sub_admin.domain.hosting.user.details') }}",
                type: "POST",
                data: {
                    id: project_id,
                    _token: '{{csrf_token()}}'
