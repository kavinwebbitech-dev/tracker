			...
			<div class="row">			  
				...
				<div class="col-lg-12 col-12">
                    ...
                    <style type="text/css">
					  ...
					  <div class="box">
						<!-- /.box-header -->
						<form class="form" action="{{ route('sub_admin.projects.update', $sub_admin->id) }}" method="post" enctype="multipart/form-data">
							@csrf
								...
								<div class="row">
										...
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<select class="form-control select2 @error('sales_person') is-invalid @enderror" name="sales_person">
			                                        ...
			                                        <option value="{{ $user_details->id ?? '' }}" @if($sub_admin->added_by== $user_details->id) selected @endif>{{ $user_details->name ?? '' }}</option>
			                                        @endif
													@endforeach
													@endif
												</select>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="date" class="form-control @error('confirm_date') is-invalid @enderror" name="confirm_date" onfocus="'showPicker' in this && this.showPicker()" value="{{ $sub_admin->sales_user_date }}">
											</div>
											@error('confirm_date')
			                                    <span class="invalid-feedback" role="alert">
			                                        <strong>{{ $message }}</strong>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="date" class="form-control @error('start_date') is-invalid @enderror" name="start_date" onfocus="'showPicker' in this && this.showPicker()" value="{{ $sub_admin->start_date }}">
											</div>
											@error('start_date')
			                                    <span class="invalid-feedback" role="alert">
			                                        <strong>{{ $message }}</strong>
									...
									<div class="col-md-4"  @if($sub_admin->is_renewal== 0) @else style="display: none;" @endif  id="end_day_display">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="date" class="form-control @error('end_date') is-invalid @enderror" name="end_date" onfocus="'showPicker' in this && this.showPicker()" value="{{ $sub_admin->end_date }}">
											</div>
											@error('end_date')
			                                    <span class="invalid-feedback" role="alert">
			                                        <strong>{{ $message }}</strong>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="text" class="form-control @error('amount') is-invalid @enderror" name="amount" placeholder="Amount" value="{{ $sub_admin->bid_amount }}">
											</div>
											@error('amount')
			                                    <span class="invalid-feedback" role="alert">
			                                        <strong>{{ $message }}</strong>
									...
									<div class="col-md-4">
										<div class="box-body">
											...
											<div class="demo-checkbox">
												<input type="checkbox" name="refunded" id="md_checkbox_7" class="chk-col-danger" @if($sub_admin->refunded != "") checked @endif>
