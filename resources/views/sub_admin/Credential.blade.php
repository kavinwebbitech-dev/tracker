...
<!-- Content Wrapper. Contains page content -->
          ...
          <div class="row">
            ...
            <div class="col-12">
             ...
             <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{ route('sub_admin.credentials.bulk.upload') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-9"></div>

                        <div class="col-md-3">
                            @if(in_array('79', $role_section))
                      ...
                      <table id="example7" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div id="viewCr{{ $value->id }}" class="">
                                        <p style="display: flex;">
                                            <a>#######</</a>
                                            <a><span style="position: relative;margin-left: 10px;cursor: pointer;" onclick="DisplayView('{{ $value->id }}')">👁️</span></a>
                                        </p>
                                    </div>
                                    <div id="hide{{ $value->id }}" class="" style="display: none;">
                                        <p style="display: flex;">
                                            <a>{{ $value->password }}</a>
                                            <a><span style="position: relative;margin-left: 10px;cursor: pointer;" onclick="DisplayHide('{{ $value->id }}')">🙈</span></a>
                                        </p>
                                ...
                                <td>
                                    ...
                                    @endif
                                    @if(in_array('81', $role_section))
                                    <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.credentials.delete', $value->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="form" action="{{ route('sub_admin.credentials.store') }}" method="post">
            @csrf
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="input-group in-bord mb-3">
                        <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="User Name" value="{{ old('username') }}" required>
                        <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                    </div>
                    @error('username')
                        <span class="invalid-feedback" role="alert">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="input-group in-bord mb-3">
                        <input type="text" class="form-control @error('password') is-invalid @enderror" id="password" name="password" placeholder="Password" value="{{ old('password') }}" required>
                        <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                    </div>
                    @error('password')
                        <span class="invalid-feedback" role="alert">
  ...
  <script type="text/javascript">
    function ViewTaskModel(ref) {
        ...
        // alert(ele);
        $.ajax({
            url: '{{ route('sub_admin.credentials.edit') }}',
            method: "POST",
            data: {
                _token: '{{ csrf_token() }}', 
                id: ele
