			...
			<div class="row">			  
				...
				<div class="col-lg-12 col-12">
                    ...
                    <style type="text/css">
					  ...
					  <div class="box">
						<!-- /.box-header -->
						<form class="form" action="{{ route('sub_admin.freelancer.request.store') }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="box-body">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<select name="cost_type" class="form-select @error('cost_type') is-invalid @enderror" required>
												...
												<option value="hourly" {{ old('cost_type') == 'hourly' ? 'selected' : '' }}>Hourly</option>
