                ...
                <div class="box">
                    <div class="box-body">
                        <div class="row">
                                  ...
                                  <table class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 80%;">Key Points</th>
                                            <th style="width: 10%;" class="noExport">Action</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr @if($value->status == "Approved") style="background: #90EE90;" @endif>
                                            ...
                                            <td>
                                                <p style="display: flex;margin-bottom: 0px;">
                                                   ...
                                                   <a href="javascript:void(0);" onclick="deleteProject('{{ route('sub_admin.freelancer.details.delete', $value->id) }}')" class="delete btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                                </p>
                                            </td>
                                        </tr>
                                        @endforeach
                            ...
                            <div class="row">
                                <form class="" action="{{ route('sub_admin.task.request.extra.store') }}" method="post">
                                    @csrf
  ...
  <script src="<?php echo url('');?>/public/admin_assets/js/vendors.min.js"></script>
    ...
    <script type="text/javascript">
        function TaskComments(id) {
            ...
            if (project_id) {
                $.ajax({
                    url: "{{ route('sub_admin.freelancer.request.update') }}",
                    type: "POST",
                    data: {
                        id: project_id,
                        _token: '{{csrf_token()}}'
