...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="{{ route('sub_admin.freelancer.request.create') }}" class="btn btn-primary">
                    ...
                    <!-- <form action="{{ route('sub_admin.projects.filter') }}" method="post"> -->
                    @csrf
    ...
    <tr 
        @if($value->total_amount != null && $value->total_amount == $value->paid_amount) 
            style="background: #f02613;" 
        @elseif($value->status == "Approved") 
            style="background: #90EE90;" 
        @elseif($value->status == "Closed") 
            style="background: #f94381;" 
        @endif
    >
        ...
        <td>
            <div class="icon-text-wrapper align-items-center">
                ...
                <div>
                    ...
                    @if($value->paid_amount != $value->total_amount)
                        ...
                        <button onclick="payAmount('{{ $value->id }}')"
        ...
        <td>
            <p style="display: flex;margin-bottom: 0px;">
                ...
                <a href="{{ route('sub_admin.freelancer.task.edit', $value->id) }}"
                    class="creative-btn-action action-edit"
                    style="padding: 4px 12px;margin: 0px 4px;">
                    <i class="ion ion-edit text-white"></i>
                </a>

                <a href="{{ route('sub_admin.freelancer.task.details', $value->id) }}"
                    class="creative-btn-action btn-success"
                    style="padding: 4px 12px;margin: 0px 4px;">
                    <i class="ti-eye text-white"></i>
                </a>

                <a href="javascript:void(0);" onclick="deleteProject('{{ route('sub_admin.freelancer.estimate.delete', $value->id) }}')"
  ...
  <script src="<?php echo url('');?>/public/admin_assets/js/vendors.min.js"></script>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" id="load_html1">
            ...
            <form action="{{ route('sub_admin.freelancer.estimate.close') }}" method="post">
            @csrf
    ...
    <script type="text/javascript">
        ...
        function ReadMore(id)
        {
            ...
            if (project_id) {
                $.ajax({
                    url: "{{ route('sub_admin.task.request.description') }}",
                    type: "POST",
                    data: {
                        id: project_id,
                        _token: '{{csrf_token()}}'
        ...
        function payAmount(id)
        {
            ...
            if (project_id) {
                $.ajax({
                    url: "{{ route('sub_admin.freelancer.request.pay') }}",
                    type: "POST",
                    data: {
                        id: project_id,
                        _token: '{{csrf_token()}}'
