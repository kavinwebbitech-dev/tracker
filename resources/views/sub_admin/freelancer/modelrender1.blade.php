...
<div class="row">
    <div class="col-md-8">
        <form action="{{ route('sub_admin.freelancer.request.comment.update') }}" method="post">
            @csrf
            <div class="row">
    ...
    <div class="col-md-4" style="border-left: 1px solid #dee2e6;height: 500px;overflow: overlay;">
        ...
        <div class="row" style="border-bottom: 1px solid #e3e3e3;">
            ...
            <div class="col-md-2">
               <a href="javascript:void(0);" onclick="deleteProject('{{ route('sub_admin.projects.task.estimate.comment.delete', $comment_details->id) }}')" class="delete btn btn-danger" data-confirm="Are you Sure Delete this Comment?" style="padding: 2px 4px;float: right;"><i class="ti-trash text-white"></i></a>
            </div>
        </div>
        @endif
        @endforeach
