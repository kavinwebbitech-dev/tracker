...
@section('content')
                                                   ...
                                                   <tr class="my-st">
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (in_array('101', $role_section))
                                                                <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.my.bills.delete', $value->id) }}')"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" min="1" class="form-control" id="recurring_value"
                                        name="recurring_value" placeholder="e.g. 3"
                                        value="{{ old('recurring_value', 1) }}" style="display: none;">
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function toggleRecurringValue() {
            var unit = $("#recurring_unit").val();
            if (unit === 'none') {
                $("#recurring_value").hide().val(1);
            } else {
                $("#recurring_value").show();
            }
        }

        $('#modal-default').on('show.bs.modal', function(e) {
            if ($(e.relatedTarget).is('[data-bs-target="#modal-default"]')) {
                $('#recurring_unit').val('none');
                $('#recurring_value').hide().val(1);
            }
        });
    </script>
