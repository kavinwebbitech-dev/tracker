            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        ...
                        <div class="col-sm-8">
                            <a class="btn btn-primary" href="{{ route('sub_admin.domain.hosting.create') }}" style="float: right;">Add New</a>
                        </div>
                        @endif
                    </div>
                    <div class="row">
                            ...
                            <tr @if($gsuite_days == 0) style="background: #f6e2f7;" @endif>
                                ...
                                <td>
                                    <p style="display: flex;">
                                       ...
                                       <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.domain.hosting.delete', $value->id) }}')" title="Delete" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                        @endif
                                    </p>
                                </td>
                            </tr>
  ...
  <script type="text/javascript">
    ...
    function text_value_search()
    {
        ...
        if (text_value_search) {
            $.ajax({
                url: "{{ route('sub_admin.domain.hosting.search') }}",
                type: "POST",
                data: {
