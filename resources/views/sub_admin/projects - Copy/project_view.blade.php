                                        ...
                                        <td>
                                            <p style="display: flex;margin: 3px 0px;">
                                                ...
                                                @if(in_array('48', $role_section))
                                                    <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.projects.amount.delete', $value1->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                                @endif
                                            </p>
                                        </td>
                                    </tr>
