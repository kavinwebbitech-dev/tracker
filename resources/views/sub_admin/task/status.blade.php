                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p style="display: flex;margin-bottom: 0px;">
                                                                            ...
                                                                            <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.task.comment.delete', $value->id) }}')" class="delete btn btn-danger" style="padding: 2px 6px;margin: 10px 1px;width: auto;"><i class="ti-trash text-white"></i></a>
                                                                            @endif
                                                                        </p>
                                                                    </td>
                                                                </tr>
