...
<!-- Content Wrapper. Contains page content -->
          ...
          <div class="row">
            ...
            <div class="col-12">
             ...
             <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{ route('sub_admin.client.bulk.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- <a href="javascript:void(0);"onclick="deleteProject('{{ route('sub_admin.client.delete', $value->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a> --}}
                                </td>
                            </tr>
                            @endforeach
                            @endif
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="form" action="{{ route('sub_admin.client.store') }}" method="post">
            @csrf
  ...
  <script type="text/javascript">
    function ViewTaskModel(ref) {
        ...
        // alert(ele);
        $.ajax({
            url: '{{ route('sub_admin.client.edit') }}',
            method: "POST",
            data: {
                _token: '{{ csrf_token() }}', 
                id: ele
