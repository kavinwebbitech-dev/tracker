...
@section('content')
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-md-3">
                                        @if (in_array('906', $role_section))
                                            <span class="corp-btn corp-btn-primary" onclick="addHostingServer()"
                                                style="float: right;">
                                                Add Hosting Server
                                            </span>
                                        @endif
                                    ...
                                    <table id="example1" class="table table-bordered table-striped creative-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Hosting Name</th>
                                                <th>Status</th>
                                                @if (in_array('907', $role_section) || in_array('908', $role_section))
                                                <th>Action</th>
                                                @endif
                                            </tr>
                                        </thead>
                                                        ...
                                                        @if (in_array('907', $role_section) || in_array('908', $role_section))
                                                            <td>
                                                                <div class="creative-action-box">
                                                                    @if (in_array('907', $role_section))
                                                                        <a href="javascript:void(0);"
                                                                            onclick="ViewTaskModel('{{ $value->id }}')"
                                                                            class="creative-btn-action action-edit"><i
                                                                                class="ion ion-edit text-white"></i></a>
                                                                    @endif
                                                                    @if (in_array('908', $role_section))
                                                                        <a href="javascript:void(0);"
                                                                            onclick="deleteProject('{{ route('sub_admin.hosting_server.delete', $value->id) }}')"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" id="hosting_server_form" action="{{ route('admin.hosting_server.store') }}"
                        method="post">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group in-bord mb-3">
                                    <input type="text"
                                        ...
                                        value="{{ old('fld_hosting_name') }}" required>
                                </div>
    ...
    <script type="text/javascript">
        ...
        const storeUrl = "{{ route('sub_admin.hosting_server.store') }}";
        const editUrl = "{{ route('sub_admin.hosting_server.edit', ':id') }}";
        const updateUrl = "{{ route('sub_admin.hosting_server.update', ':id') }}";
