...
@section('content')
                                ...
                                <div class="row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-md-3">
                                        @if (in_array('909', $role_section))
                                            <span class="corp-btn corp-btn-primary" onclick="addDomainServer()"
                                                style="float: right;">
                                                Add Domain Server
                                            </span>
                                        @endif
                                    ...
                                    <table id="example1" class="table table-bordered table-striped creative-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Status</th>
                                                @if (in_array('909', $role_section) || in_array('909', $role_section))
                                                    <th>Action</th>
                                                @endif
                                            </tr>
                                        </thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="icon-text-wrapper">
                                                                ...
                                                                <span
                                                                    class="fw-semibold">{{ $value->fld_domain_server_name }}</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            ...
                                                            @else
                                                                <span class="creative-badge creative-badge-inactive"><i
                                                                        class="bi bi-x-circle-fill"></i> In Active</span>
                                                            @endif
                                                        </td>
                                                        @if (in_array('909', $role_section) || in_array('909', $role_section))
                                                            <td>
                                                                <div class="creative-action-box">
                                                                    ...
                                                                    @if (in_array('909', $role_section))
                                                                        <a href="javascript:void(0);"
                                                                            onclick="deleteProject('{{ route('sub_admin.domain_server.delete', $value->id) }}')"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" id="domain_server_form" action="{{ route('sub_admin.domain_server.store') }}"
                        method="post">
                        @csrf
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text"
                                        class="form-control @error('fld_domain_server_name') is-invalid @enderror"
                                        id="fld_domain_server_name" name="fld_domain_server_name"
                                        placeholder="Domain Server Name" value="{{ old('fld_domain_server_name') }}"
                                        required>
                                </div>
    ...
    <script type="text/javascript">
        const storeUrl = "{{ route('sub_admin.domain_server.store') }}";
        const editUrl = "{{ route('sub_admin.domain_server.edit', ':id') }}";
        const updateUrl = "{{ route('sub_admin.domain_server.update', ':id') }}";
