             ...
             <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="table-responsive">
                      ...
                      <table id="example" class="table table-bordered table-striped nowrap-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Date</th>
    ...
    <tr>
            ...
            <div class="icon-text-wrapper">
                ...
                <span class="fw-semibold">
                    ...
                    @else
                        ...
                        <?php
                            $task_comments = \App\Models\TaskComment::where('task_id', $value->task_details->id)
        ...
        <td>
            <div class="icon-text-wrapper">
                ...
                <span class="fw-semibold">
                    {{ $value->task_details->assign_details->name ?? '' }}
                </span>
        ...
        <td>
            ...
            <p style="display: flex;">
                ...
                <a href="{{ route('admin.task.status', $value->task_details->id) }}"
                ...
                <a href="{{ route('task.edit', $value->task_details->id) }}"
                    class="creative-btn-action action-edit"
                    style="margin: 5px 4px;">
                    <i class="ion ion-edit text-white"></i>
                </a>

                <a href="javascript:void(0);"onclick="deleteProject('{{ route('admin.task.single.delete', $value->id) }}')"
