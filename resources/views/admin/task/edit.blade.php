...
@section('content')
                            ...
                            <form class="form" action="{{ route('task.update', $task->id) }}" method="post">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group in-bord mb-3">
                                                    <select class="form-control @error('task_type') is-invalid @enderror"
                                                        ...
                                                        <option value="custom"
                                                            @if ($task->task_type == 'custom') selected @endif>One time Task
                                                        </option>
                                                ...
                                                <div class="input-group in-bord mb-3">
                                                    <select class="form-control @error('user_type') is-invalid @enderror"
                                                        ...
                                                        <option value="sub_admin"
                                                            @if ($task->sub_admin_id == '') selected @endif> Sub Admin
                                                        </option>
                                                        <option value="staff"
                                                            @if ($task->sub_admin_id != '') selected @endif> Staff
                                                        </option>
                                                    </select>
                                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                                </div>
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($sub_admin as $key => $value)
                                                                <option value="{{ $value->id }}"
                                                                    @if ($task->staff_id == $value->id) selected @endif>
                                                                    {{ $value->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                        ...
                                        <div class="col-md-6" id="check_dynamic1"
                                            @if ($task->sub_admin_id != '') style="display:block;" @else  style="display:none;" @endif>

                                            <div class="form-group">
                                                <label class="form-label">Select Sub Admin</label>
                                                <div class="input-group in-bord mb-3">
                                                    <select class="form-control @error('sub_admin_id') is-invalid @enderror"
                                                        name="sub_admin_id" id="sub_admin_id" onchange="sub_admin_check()">
                                                        <option value=""> Select Sub Admin</option>
                                                        @foreach ($sub_admin as $key => $value)
                                                            <option value="{{ $value->id }}"
                                                                @if ($task->sub_admin_id == $value->id) selected @endif>
                                                                {{ $value->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                        ...
                                        <div class="col-md-6" id="check_dynamic2"
                                            @if ($task->sub_admin_id != '') style="display:block;" @else  style="display:none;" @endif>
                                                ...
                                                <div class="input-group in-bord mb-3">
                                                    <select
                                                        ...
                                                        {{-- @foreach ($staff as $key => $value1)
                                                            ...
                                                            @if ($task_details)
                                                                <option value="{{ $value1->id }}"
                                                                    @if ($task_details->staff_id == $value1->id) selected @endif>
                                                                    {{ $value1->name }}</option>
                                                            @else
                                                        ...
                                                        @foreach ($staff as $key => $value1)
                                                            ...
                                                            @if ($task_details)
                                                                <option value="{{ $value1->id }}"
                                                                    data-role="{{ $value1->role }}"
                                                                    @if ($task_details->staff_id == $value1->id) selected @endif>
                                                                    {{ $value1->name }}</option>
                                                            @else
                                                                <option value="{{ $value1->id }}"
                                                                    data-role="{{ $value1->role }}"> {{ $value1->name }}
                                                                </option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                            ...
                                            @foreach ($task->task_staff as $key => $task_staff)
                                                <div class="form-group row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="hidden"
                                                            name="addmore[{{ $task_staff->staff_id }}][id]"
                                                            value="{{ $task_staff->staff_details->id ?? '' }}">
                                                        <input type="text" class="form-control"
                                                            name="addmore[{{ $task_staff->staff_id }}][name]"
                                                            value="{{ $task_staff->staff_details->name ?? '' }}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="form-label">Start Date</label>
                                                        <input type="date" class="form-control"
                                                            name="addmore[{{ $task_staff->staff_id }}][start_date]"
                                                            placeholder="" value="{{ $task_staff->start_date ?? '' }}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="form-label">End Date</label>
                                                        <input type="date" class="form-control"
                                                            name="addmore[{{ $task_staff->staff_id }}][end_date]"
                                                            placeholder="test1"
                                                            value="{{ $task_staff->end_date ?? '' }}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group in-bord mb-3">
                                                                <select class="form-control"
                                                                    name="addmore[{{ $task_staff->staff_id }}][priority]">
                                                                    <option value="">Select Priority</option>
                                                                    <option value="High"
                                                                        @if ($task_staff->priority == 'High') selected @endif>
                                                                        High</option>
                                                                    <option value="Medium"
                                                                        @if ($task_staff->priority == 'Medium') selected @endif>
                                                                        Medium</option>
                                                                    <option value="Low"
                                                                        @if ($task_staff->priority == 'Low') selected @endif>
                                                                        Low</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group row border-bottom pb-3 mb-3">
                                                    ...
                                                    <div class="col-md-3 mt-2">
                                                        ...
                                                        <input type="number" step="0.5" min="0"
                                                            class="form-control"
                                                            name="addmore[{{ $task_staff->staff_id }}][assigned_frontend_hours]"
                                                            value="{{ $task_staff->assigned_frontend_hours ?? 0 }}">
                                                    </div>
                                                    <div class="col-md-3 mt-2">
                                                        <label class="form-label">Backend Hours</label>
                                                        <input type="number" step="0.5" min="0"
                                                            class="form-control"
                                                            name="addmore[{{ $task_staff->staff_id }}][assigned_backend_hours]"
                                                            value="{{ $task_staff->assigned_backend_hours ?? 0 }}">
                                                    </div>
                                                    <div class="col-md-3 mt-2">
                                                        <label class="form-label">SEO Hours</label>
                                                        <input type="number" step="0.5" min="0"
                                                            class="form-control"
                                                            name="addmore[{{ $task_staff->staff_id }}][assigned_seo_hours]"
                                                            value="{{ $task_staff->assigned_seo_hours ?? 0 }}">
                                                    </div>
                                                    <div class="col-md-3 mt-2">
                                                        <label class="form-label">Testing Hours</label>
                                                        <input type="number" step="0.5" min="0"
                                                            class="form-control"
                                                            name="addmore[{{ $task_staff->staff_id }}][assigned_testing_hours]"
                                                            value="{{ $task_staff->assigned_testing_hours ?? 0 }}">
                                                    </div>
                                                </div>
                                            @endforeach
                                        @endif
                                    ...
                                    $hourFieldMeta = [
                                        'frontend' => ['label' => 'Frontend Hours', 'name' => 'assigned_frontend_hours'],
                                        'backend' => ['label' => 'Backend Hours', 'name' => 'assigned_backend_hours'],
                                        'seo' => ['label' => 'SEO Hours', 'name' => 'assigned_seo_hours'],
                                        'testing' => ['label' => 'Testing Hours', 'name' => 'assigned_testing_hours'],
                                        'designer' => ['label' => 'Designer Hours', 'name' => 'assigned_designer_hours'],
                                    ];
                                    ?>
                                    <div class="row" id="customer_choice_options">
                                        @if ($task->task_staff)
                                            @foreach ($task->task_staff as $key => $task_staff)
                                                <?php
                                                $staff_role = trim($task_staff->staff_details->role ?? '');
                                                $visible_keys = array_key_exists($staff_role, $roleHourMap) ? $roleHourMap[$staff_role] : array_keys($hourFieldMeta);
                                                ?>
                                                <div class="form-group row border-bottom pb-3 mb-3"
                                                    id="staff_row_{{ $task_staff->staff_id }}">
                                                    <div class="col-md-3">
                                                        <label class="form-label">Name</label>
                                                        <input type="hidden"
                                                            name="addmore[{{ $task_staff->staff_id }}][id]"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control"
                                                            ...
                                                            <option value="">Select Priority</option>
                                                            <option value="High"
                                                                @if ($task_staff->priority == 'High') selected @endif>High
                                                            </option>
                                                            <option value="Medium"
                                                                @if ($task_staff->priority == 'Medium') selected @endif>Medium
                                                            </option>
                                                            <option value="Low"
                                                                @if ($task_staff->priority == 'Low') selected @endif>Low
                                                            </option>
                                                        </select>
                                                    </div>
                                                    @foreach ($visible_keys as $hkey)
                                                        <?php $meta = $hourFieldMeta[$hkey]; ?>
                                                        <div class="col-md-3 mt-2">
                                                            <label class="form-label">{{ $meta['label'] }}</label>
                                                            <input type="number" step="0.5" min="0"
                                                                class="form-control"
                                                                name="addmore[{{ $task_staff->staff_id }}][{{ $meta['name'] }}]"
                                                                value="{{ $task_staff->{$meta['name']} ?? 0 }}">
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endforeach
                                                ...
                                                <div class="input-group in-bord mb-3">
                                                    <select
                                                        ...
                                                        @foreach ($sub_admin1 as $key => $value)
                                                            <option value="{{ $value->id }}"
                                                                @if ($value->id == $task->payment_follow_up) selected @endif>
                                                                {{ $value->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group in-bord mb-3">
                                                    <select
                                                        ...
                                                        @foreach ($sub_admin1 as $key => $value)
                                                            <option value="{{ $value->id }}"
                                                                @if ($value->id == $task->project_follow_up) selected @endif>
                                                                {{ $value->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        function buildHourFields(i, role) {
            ...
            const existing = existingAssignedData[i] || {};

            return keys.map(function(key) {
                const f = hourFields[key];
                const val = existing[f.name] !== undefined ? existing[f.name] : 0;
                return '<div class="col-md-3 mt-2">' +
                    '<label class="form-label">' + f.label + '</label>' +
                    '<input type="number" step="0.5" min="0" class="form-control"' +
                    ' name="addmore[' + i + '][' + f.name + ']" value="' + val + '" placeholder="0">' +
                    '</div>';
            }).join('');
        }
        ...
        function add_more_customer_choice_option(i, text, role) {
            ...
            $('#customer_choice_options').show().append(
                ...
                '<div class="col-md-3">' +
                '<label class="form-label">Start Date</label>' +
                '<input type="date" class="form-control" name="addmore[' + i + '][start_date]" value="' + startDate +
                '">' +
                '</div>' +
                '<div class="col-md-3">' +
                '<label class="form-label">End Date</label>' +
                '<input type="date" class="form-control" name="addmore[' + i + '][end_date]" value="' + endDate + '">' +
                '</div>' +
                '<div class="col-md-3">' +
                '<label class="form-label">Task Priority</label>' +
                '<select class="form-control" name="addmore[' + i + '][priority]">' +
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '#multiple_staff', function() {
                ...
                $('#multiple_staff option:selected').each(function() {
                    ...
                    console.log('Selected staff:', name, '| role attr:', role);
    ...
    <script>
        const existingAssignedData = {!! json_encode(
            $task->task_staff->mapWithKeys(function ($ts) {
                return [
                    $ts->staff_id => [
                        'start_date' => $ts->start_date,
                        'end_date' => $ts->end_date,
                        'priority' => $ts->priority,
                        'assigned_frontend_hours' => $ts->assigned_frontend_hours,
                        'assigned_backend_hours' => $ts->assigned_backend_hours,
                        'assigned_seo_hours' => $ts->assigned_seo_hours,
                        'assigned_testing_hours' => $ts->assigned_testing_hours,
                        'assigned_designer_hours' => $ts->assigned_designer_hours,
                    ],
                ];
            }),
        ) !!};
