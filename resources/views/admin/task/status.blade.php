...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
      <div class="container-full">
        ...
        <?php
            $original_project_amount = 0;
            if (isset($task->project_details->bid_amount) && $task->project_details->bid_amount) {
                $original_project_amount = $task->project_details->bid_amount;
            }
        ?>
          <div class="row">
            <div class="col-lg-12">
                <div class="box">
                    <div class="box-body">
                        <div class="row">
                            ...
                            @else
                                <a href="{{ route('admin.closed.status.task', $task->id) }}" class="delete btn btn-primary" data-confirm="Are you Sure Closed this task?">Closed Task</a>
                            @endif
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6 col_padding">Staff Name</div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="ViewTaskModelRecur('{{ $value->id }}')" class="btn btn-success" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-eye text-white"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endif
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col_padding">- {{ date('d-m-Y', strtotime($task->created_at)) }}</div>
                                        </div>
                                    </div> --}}
                                    <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        ?>
                                          ...
                                          @foreach($task->task_staff as $key => $staff)
                                            <li><a @if($key == 0) class="active" @endif href="#activity{{ $key }}" data-bs-toggle="tab">{{ $staff->staff_name }}</a></li>
                                          @endforeach
                                          @endif
                                          <li><a href="#activity101" data-bs-toggle="tab">Follow Up Comment</a></li>
                                          <li><a href="#activity111" data-bs-toggle="tab">Payment Comment</a></li>
                                        </ul>
                                          ...
                                          @foreach($tasf_task as $key1 => $staff)
                                            <div class="@if($key1 == 0) active @endif tab-pane" id="activity{{ $key1 }}">       
                                                <?php
                                                    ...
                                                    $date2 = strtotime($staff->end_date);
                                                    // $points = 1;
                                                    if ($date2 >= $date1) {
                                                        $points = false;
                                                    }
                                                    ...
                                                    $add_hours = 0;
                                                    $staff_comments = \App\Models\TaskComment::where('task_id', $staff->task_id)->where('staff_id', $staff->staff_id)->where('is_delete', 1)->get();
                                                ...
                                                ?>
                                                {{-- <a href="{{ route('admin.closed.status.task', $task->id) }}" class="delete1 btn btn-warning" data-confirm="Are you Sure Closed this task?" style="float: right;margin-bottom: 10px;">+ Points</a> --}}
                                                  ...
                                                  <div class="media bb-1 border-fade">
                                                    ...
                                                    <div class="media-body">
                                                      <p>
                                                        ...
                                                        <time class="float-end text-fade" datetime="2017">Start Date: {{ $staff->start_date }}</time>
                                                      </p>
                                                      <p>
                                                        <small>{{ $staff->staff_details->role ?? '' }}</small>
                                                        <time class="float-end text-fade" datetime="2017">End Date: {{ $staff->end_date }}</time>
                                                      </p>
                                                      <p>
                                                        <small>Total Hours: {{ $total_time }}</small>
                                                ...
                                                <form action="{{ route('admin.task.hours.update') }}" method="post">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-9"></div>
                                                        <div class="col-md-3">
                                                            <p style="display: flex;">
                                                                <a onclick="EditAdminHours()" id="EditAdminHours" class="btn btn-success" style="padding: 7px 9px 10px;margin: 0px 1px;"><i class="ion ion-edit text-white"></i> Edit Admin Hours</a>
                                                                <input type="submit" name="submit" id="EditAdminHours1" class="btn btn-success" style="padding: 7px 9px 10px;margin: 0px 1px;display: none;" value="Upload Admin Hours">

                                                                <input type="submit" name="submit" class="btn btn-danger" style="padding: 7px 9px 10px;margin: 0px 1px;" value="Same User to Admin">
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr>
                                                                    <th>
                                                                        S No<br>
                                                                        <input type="checkbox" id="check_all" style="position: relative;opacity: 1;left: 0;">
                                                                    </th>
                                                                    <th>Name</th>
                                                                    <th>Start Date</th>
                                                                    <th>End Date</th>
                                                                    <th>Staff Working Hours</th>
                                                                    <th>Admin Working Hours</th>
                                                                    <th>User Comment</th>
                                                                    <th>Admin Comment</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <input type="hidden" name="admin_time[{{ $key3 }}][id]" value="{{ $value->id ?? '' }}">
                                                                <tr>
                                                                    <td>
                                                                        {{ $key3 + 1}}
                                                                        <input type="checkbox" class="checkbox" name="admin_time[{{ $key3 }}][checkbox]" style="position: relative;opacity: 1;left: 0;">
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <p class="admin_comments_alreay">{{ $value->add_working_hours }}</p>
                                                                        <div class="admin_comments" id="admin_comments" style="display: none;">
                                                                            <input type="text" name="admin_time[{{ $key3 }}][add_work_time]" value="{{ $value->add_working_hours ?? '' }}" style="width: 100px;padding: 3px 8px;border: 1px solid #e1e1e1;border-radius: 10px;">
                                                                        </div>
                                                                    </td>
                                                                    <td>{{ $value->user_comment }}</td>
                                                                    <td>{{ $value->admin_comment }}</td>
                                                                    <td>{{ $value->client_comment }}</td>
                                                                    <td>
                                                                        <p style="display: flex;">
                                                                            <a onclick="ViewTaskModel5('{{ $value->id }}', '{{  $value->working_hours }}')" class="btn btn-success" style="padding: 2px 6px;margin: 0px 1px;"><i class="ion ion-edit text-white"></i></a>
                                                                            
                                                                            <a href="javascript:void(0);"onclick="deleteProject('{{ route('task.comment.delete', $value->id) }}')" class="delete btn btn-danger" style="padding: 2px 6px;margin: 0px 1px;width: auto;"><i class="ti-trash text-white"></i></a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                @endforeach
                                            ...
                                            <div class="tab-pane" id="activity111">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9"><span style="float: right;">Project Amount</span></div>
                                        @php
                                            $original_project_amount = (int) $original_project_amount;
                                        @endphp
                                        <div class="col-md-3" style="text-align: right;">{{ number_format($original_project_amount, 2) }}</div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-md-9"><span style="float: right;">Total Working Amount</span></div>
                                        <div class="col-md-3" style="text-align: right;">{{ number_format($project_amount, 2) }}</div>
                                    </div>
                                    <hr>
                                    <?php $earn = $original_project_amount - $project_amount; ?>
                                    <div class="row">
                                        <div class="col-md-9"><span style="float: right;">Earning Amount</span></div>
                                        <div class="col-md-3" style="text-align: right;">{{ number_format($earn, 2) }}</div>
                                    </div>
                                    <hr>
                                </div>
                            @endif
  ...
  <script type="text/javascript">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" id="load_html">
            <form action="{{ route('admin.task.update.comment') }}" method="post">
                @csrf
    ...
    <script type="text/javascript">
        function ViewTaskModel5(ref, ref1) {
            var ele = ref;
            var ele1 = ref1;
            // alert(ele);
            if (ref) {
    ...
    <div class="modal fade" id="myModal7">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" id="load_html">
            <form action="{{ route('admin.task.details.time.update') }}" method="post">
                @csrf
    ...
    <div class="modal fade" id="modal-default7">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" id="load_html">
            <form action="{{ route('admin.follow.up.comments.project') }}" method="post">
                @csrf
                <input type="hidden" name="project_follow_id" id="project_follow_id" value="{{ $user_details->id ?? '' }}">
    ...
    <div class="modal fade" id="modal-default2">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" id="load_html">
            <form action="{{ route('admin.follow.up.project.payment') }}" method="post">
                @csrf
                <input type="hidden" name="project_follow_id" id="payment_follow_id" value="{{ $user_details1->id ?? '' }}">
                <input type="hidden" name="task_id" id="task_id" value="{{ $task->id }}">
                <input type="hidden" name="project_id" id="project_id" value="{{ $task->project_id }}">
                <div class="row">
                    <div class="col-md-6">
    ...
    <script type="text/javascript">
        ...
        function ViewTaskModelRecur(ref) {
            var ele = ref;
            // alert(ele);
            $.ajax({
                url: '{{ route('super.admin.model.render') }}',
                ...
                success: function (response) {
                    // console.log(response);
                    $("#load_html7").html(response.html);
                    $('#modal-default-recur').modal('show');
                }
            });
        }

        function EditAdminHours() {
           
            $(".admin_comments").show();
            $("#EditAdminHours").hide();
            $("#EditAdminHours1").show();
            $(".admin_comments_alreay").hide();
    ...
    <script>
        ...
        checkAll.addEventListener('change', function() {
            // Set the checked property of all checkboxes to match the "Check All" checkbox
    ...
    <div class="modal fade" id="modal-default-recur">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body" id="load_html7">
