    ...
    <tr>
        ...
        <td>
            <p style="display: flex;">
                ...
                <a href="javascript:void(0);"onclick="deleteProject('{{ route('admin.task.single.delete', $value->id) }}')" class="btn btn-danger" style="margin: 5px 4px;"><i class="ti-trash text-white"></i></a>
                @endif
            </p>
