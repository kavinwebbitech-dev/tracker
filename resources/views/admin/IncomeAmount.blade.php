        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="me-auto">
                        <h3 class="page-title">Income Amount super</h3>
                                ...
                                <form action="{{ route('admin.imcome.amount.export') }}" method="post"
                                    ...
                                    <div class="row" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-md-6 d-flex gap-2">
                                         ...
                                         <div class="col-md-6"><span class="btn btn-primary" style="float: right; cursor: pointer;"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p style="display: flex;">
                                                                ...
                                                                <a href="javascript:void(0);" onclick="deleteProject('{{ route('admin.imcome.amount.delete', $value->id) }}')"
