                ...
                <div class="box">
                    <div class="box-body">
                        <div class="row">
                            ...
                            @if($project->is_renewal)
                                @if($project->stop_project == 1)
                                @else
                                <div class="row" style="margin-bottom: 20px;">
                                    <div class="col-md-2">
                                        <a href="{{ route('admin.projects.stop.recurring', $project->id) }}" class="delete btn btn-danger" data-confirm="Are you Stop this Project?">Stop Recurring Project</a>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col_padding">- {{ $project->added_user_details->name ?? '' }}</div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-md-12">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <ul class="nav nav-tabs">
                              <li style="width: 32%;"><a href="#usertimeline" data-bs-toggle="tab">Task Details</a></li>
                                            ...
                                            <div class="panel-body">
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                {{ $task->task_details->name }} ({{ $task->task_details->task_no }}) <a href="{{ route('admin.task.status', $task->task_details->id) }}" class="btn btn-success" style="width: 23px;height: 24px;padding: 0px;border-radius: 16px;" target="_blank"><i class="ti-eye text-white" style="font-size: 10px;"></i></a>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p style="display:flex;">
                                                                    ...
                                                                    <a href="javascript:void(0);" onclick="deleteProject('{{ route('admin.projects.payment.delete', $value1->id) }}')" class="delete btn btn-danger" data-confirm="Are you Sure Delete this payment?" style="padding: 4px 12px;margin: 0px 4px;width: 40px;"><i class="ti-trash"></i></a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        @endforeach
  ...
  <script src="<?php echo url('');?>/public/admin_assets/js/vendors.min.js"></script>
    ...
    <script type="text/javascript">
        function ViewTaskModel(id) {
            ...
            if (project_id) {
                $.ajax({
                    url: "{{ route('admin.projects.payment.edit.details') }}",
                    type: "POST",
                    data: {
                        id: project_id,
                        _token: '{{csrf_token()}}'
