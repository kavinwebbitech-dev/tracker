                            ...
                            <a href="{{ route('admin.proposal.create') }}" class="btn btn-primary-light btn-sm add_button" style="float: right;">Add Proposals</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <select class="form-control @error('salesperson') is-invalid @enderror"
                                    ...
                                    <div class="col-md-2">
                                        <input type="submit" name="submit" class="btn btn-primary" onclick="sort_book()"
                                            value="Submit">
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <tbody>
                                            @if ($users)
                                                @foreach ($users as $key => $value)
                                                    ...
                                                    <tr @if ($value->status == 6) style="background: #ff3649;" @endif
