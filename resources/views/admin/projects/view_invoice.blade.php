...
margin: 40px 0 !important;
  ...
  ?>
    <table class="table-no-border">
        <tr>
            ...
            <img src="{{ public_path('admin_assets/images/logo.png') }}" alt="Logo" style="width: 200px;">
            </td>
  ...
  <div>
    ...
    <table class="product-table">
        <thead>
            <tr>
                <th width="7%" style="border-bottom: 1px solid #00AFF0;text-align: center;">
                    <strong>S.No</strong>
                </th>
                 <th width="25%"  style="border-bottom: 1px solid #00AFF0;text-align: center;">
                    <strong>Project</strong>
                </th>

                 <th width="20%" style="border-bottom: 1px solid #00AFF0;text-align: center;">
                    <strong>Sales User </strong>
                </th>
                
                <th width="15%" style="border-bottom: 1px solid #00AFF0;text-align: center;">
                    <strong>Total Amount</strong>
                </th>
                <th  width="20%" style="border-bottom: 1px solid #00AFF0;text-align: center;white-space:nowrap;">
                    <strong>Pending</strong>
                </th>
                 <th width="13%"  style="border-bottom: 1px solid #00AFF0;text-align: center;">
        ...
        <tbody>
            ...
            @if($users)
              ...
              ?>
              <tr style="text-align:center; {{ $value->status == 6 ? 'background:#dc3545;' : '' }}">
                  <td>{{ $key + 1}}</td>
                  <td>{{ $value->name }}</td>
