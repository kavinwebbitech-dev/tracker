...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    ...
                    <div class="table-responsive creative-table-wrapper">
                      <table id="example_render" class="table creative-table table-bordered table-hover display nowrap margin-top-10 w-p100">
                        <thead>
                            <tr>
                                <th>S No</th>
                                <th>Project</th>
    ...
    <tr 
        @if($value->status == 6) style="background: #dc3545;" @endif
    ...
    >
        ...
        <td>
            <div class="count-icons d-flex align-items-center justify-content-center gap-2">
  ...
  <?php
    $current_route = route('admin.projects.year.wise', $id);
  ...
  <script type="text/javascript">
    ...
    function sort_book() {
        ...
        var expert_search_url   = "{{ $current_route }}";
        var start_date          = $("#start_date").val();
        var end_date            = $("#end_date").val();
        var status              = $("#status").val();
        var salesperson         = $("#salesperson").val();
