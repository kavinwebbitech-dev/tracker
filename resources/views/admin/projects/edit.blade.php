            ...
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="box">
                            <!-- /.box-header -->
                            <form class="form" action="{{ route('admin.projects.update', $sub_admin->id) }}"
                                method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="previous_url" value="{{ $url_previ }}">
                                <div class="box-body">
                                    <div class="row" style="margin-bottom: 20px;">
                                        <div class="col-md-4">
                                            <label for="chkPassport" style="font-size: 18px;font-weight: 700;">
                                                <input type="radio" id="normal_projects" name="project_type"
                                                    onclick="ShowHideDiv('normal_projects')" value="normal_projects"
                                                    @if ($sub_admin->is_renewal == 0) checked @endif />
                                                Regular Project
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="chkPassport" style="font-size: 18px;font-weight: 700;color: red;">
                                                <input type="radio" id="renewal_projects" name="project_type"
                                                    onclick="ShowHideDiv('renewal_projects')" value="renewal_projects"
                                                    @if ($sub_admin->is_renewal == 1) checked @endif />
                                                Renewal Project
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                                        ...
                                                        @if ($customers)
                                                            @foreach ($customers as $key => $users)
                                                                <option value="{{ $users->id }}"
                                                                    @if ($sub_admin->customer_id == $users->id) selected @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="form-control @error('status') is-invalid @enderror"
                                                        name="status">
                                                        <option value="0"
                                                            @if ($sub_admin->status == 0) selected @endif>Pending
                                                        </option>
                                                        <option value="1"
                                                            @if ($sub_admin->status == 1) selected @endif>On Progress
                                                        </option>
                                                        <option value="3"
                                                            @if ($sub_admin->status == 3) selected @endif>On Hold
                                                        </option>
                                                        <option value="5"
                                                            @if ($sub_admin->status == 5) selected @endif>Done</option>
                                                        <option value="6"
                                                            @if ($sub_admin->status == 6) selected @endif>Cancel
                                                        </option>
                                                    </select>
                                                </div>
                                                @error('status')
                                                            ...
                                                            @foreach ($salesperson as $key => $users)
                                                                ...
                                                                @if (isset($user_details->id) && $user_details->id)
                                                                    <option value="{{ $user_details->id ?? '' }}"
                                                                        @if ($sub_admin->added_by == $user_details->id) selected @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="date"
                                                        ...
                                                        value="{{ $sub_admin->sales_user_date }}">
                                                </div>
                                                @error('confirm_date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-4"
                                            @if ($sub_admin->is_renewal == 0) @else style="display: none;" @endif
                                            id="end_day_display">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4"
                                            @if ($sub_admin->is_renewal == 1) @else style="display: none;" @endif
                                                    ...
                                                    <select
                                                        ...
                                                        @if ($services)
                                                            @foreach ($services as $key => $ser)
                                                                <option value="{{ $ser->id }}"
                                                                    @if ($sub_admin->services_id == $ser->id) selected @endif>
                                                                    {{ $ser->name }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" step="0.1" min="0"
                                                            ...
                                                            name="designer_hours"
                                                            value="{{ old('designer_hours', $sub_admin->designer_hours) }}"
                                                            placeholder="Designer Time">
                                                    </div>
                                                    @error('designer_hours')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" step="0.1" min="0"
                                                            ...
                                                            name="frontend_hours"
                                                            value="{{ old('frontend_hours', $sub_admin->frontend_hours) }}"
                                                            placeholder="Frontend Time">
                                                    </div>
                                                    @error('frontend_hours')
                                                        <span class="invalid-feedback d-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" step="0.1" min="0"
                                                            ...
                                                            name="backend_hours"
                                                            value="{{ old('backend_hours', $sub_admin->backend_hours) }}"
                                                            placeholder="Backend Time">
                                                    </div>
                                                    @error('backend_hours')
                                                        <span class="invalid-feedback d-block">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" step="0.1" min="0"
                                                            ...
                                                            name="seo_hours"
                                                            value="{{ old('seo_hours', $sub_admin->seo_hours) }}"
                                                            placeholder="SEO Time">
                                                    </div>
                                                    @error('seo_hours')
                                                        <span class="invalid-feedback d-block">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" step="0.1" min="0"
                                                            ...
                                                            name="testing_hours"
                                                            value="{{ old('testing_hours', $sub_admin->testing_hours) }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="box-body">
                                                ...
                                                <div class="demo-checkbox">
                                                    <input type="checkbox" name="refunded" id="md_checkbox_7"
                                                        class="chk-col-danger"
                                                        @if ($sub_admin->refunded != '') checked @endif>
                                                    <label for="md_checkbox_7">Refunded</label>
                                                </div>
