...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-full">
            ...
            <?php
            // Month wise total for the records currently loaded (already filtered by
            // the controller via start_date / month), grouped by fld_amc_end_date so it
            // matches the "Expiry Date" column shown in the table.
            $year_month_wise_total = [];
            if ($domainhosting) {
                foreach ($domainhosting as $value) {
                    $year_key = date('Y', strtotime($value->fld_amc_end_date));
                    $month_key = date('m', strtotime($value->fld_amc_end_date));
                    $month_label = date('F', strtotime($value->fld_amc_end_date));
                    ...
                    $year_month_wise_total[$year_key]['months'][$month_key]['total'] += $value->fld_amc_total_amount;
                    $year_month_wise_total[$year_key]['year_total'] += $value->fld_amc_total_amount;
                }
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row" style="margin-bottom: 20px;">
                                    ...
                                    <div class="col-sm-4">
                                        <a class="btn btn-primary" href="{{ route('admin.amc.create') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" name="text_value_search" id="text_value_search"
                                            ...
                                            style="position: absolute;width: 200px;z-index: 99;">
                                    </div>
                                </div>
                                <style type="text/css">
                                    .add_button {
                                                    ...
                                                    <tr
                                                            ...
                                                            <div class="icon-text-wrapper">
                                                                ...
                                                                <div>
                                                                    <span class="fw-bold text-dark d-block"
                                                                        ...
                                                                        ?>
                                                                        {{ $customer_details->fld_company_name }}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="icon-text-wrapper mb-1">
                                                                ...
                                                                <span
                                                                    class="fw-semibold">{{ date('d-m-Y', strtotime($value->fld_amc_reg_date)) }}</span>
                                                            </div>
                                                        </td>
                                                        <td data-order="{{ $diff->days }}">
                                                            <div class="icon-text-wrapper mb-1">
                                                                <i class="bi bi-calendar-fill text-success"></i>
                                                                <span
                                                                    class="fw-semibold">{{ date('d-m-Y', strtotime($value->fld_amc_end_date)) }}</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="icon-text-wrapper mb-1">
                                                                ...
                                                                <span
                                                                    class="fw-semibold">{{ $value->fld_amc_dh_tenure }}</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="icon-text-wrapper mb-1">
                                                        ...
                                                        <td>
                                                            <p style="display: flex;">
                                                                ...
                                                                <a href="javascript:void(0);" onclick="deleteProject('{{ route('admin.amc.delete', $value->id) }}')"
                                                                    title="Delete"
