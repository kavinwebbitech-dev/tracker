...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <tr>
        ...
        <td>
            <div class="icon-text-wrapper mb-1">
                ...
                <span class="fw-semibold">
                    {{ date('d-m-Y', strtotime($value->fld_amc_reg_date)) }}
                </span>
            </div>
        </td>
        ...
        <td>
            <div class="icon-text-wrapper mb-1">
                <i class="bi bi-calendar-fill text-danger"></i>
                <span class="fw-semibold">
                    {{ date('d-m-Y', strtotime($value->fld_amc_end_date)) }}
                </span>
            </div>
        </td>
        ...
        <td>
            <p style="display: flex;">
                ...
                <a href="{{ route('admin.amc.interest', $value->id) }}"
                    data-confirm="Are you Sure Move Interest?"
                    title="Interest"
