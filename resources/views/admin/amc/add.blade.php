...
<!-- Content Wrapper. Contains page content -->
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h3 class="page-title">Create AMC Hosting</h3>
			...
			<div class="row">			  
				...
				<div class="col-lg-12 col-12">
                    ...
                    @endif
					  <div class="box">
						<!-- /.box-header -->
						<form class="form" action="{{ route('admin.amc.store') }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="box-body">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<textarea type="text" class="form-control @error('fld_amc_dh_details') is-invalid @enderror" name="fld_amc_dh_details" placeholder="Details" value="{{ old('fld_amc_dh_details') }}" required></textarea>
											</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="date" class="form-control @error('fld_amc_reg_date') is-invalid @enderror" name="fld_amc_reg_date" id="fld_amc_reg_date" value="{{ old('fld_amc_reg_date') }}" required onkeyup="TaxCalculate()">
											</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="date" class="form-control @error('fld_amc_end_date') is-invalid @enderror" name="fld_amc_end_date" id="fld_amc_end_date" value="{{ old('fld_amc_end_date') }}" required>
											</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="text" class="form-control @error('fld_amc_tax_rate') is-invalid @enderror" name="fld_amc_tax_rate" id="fld_amc_tax_rate" placeholder="Tax Rate" value="{{ old('fld_amc_tax_rate') }}" required>
											</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												...
												<input type="text" class="form-control @error('fld_amc_amount') is-invalid @enderror" name="fld_amc_amount" id="fld_amc_amount" placeholder="Amount" value="{{ old('fld_amc_amount') }}" required onkeyup="TaxCalculate()">
											</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="text" class="form-control @error('fld_amc_total_amount') is-invalid @enderror" name="fld_amc_total_amount" id="fld_amc_total_amount" placeholder="Total Amount" value="{{ old('fld_amc_total_amount') }}" readonly>
											</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<textarea type="text" class="form-control @error('fld_amc_description') is-invalid @enderror" name="fld_amc_description" placeholder="Description" rows="4"></textarea>
											</div>
  ...
  <script type="text/javascript">
  	...
  	function TaxCalculate() {
  		var fld_amount = $('#fld_amc_amount').val();
  		var fld_tax_percentage = $('#fld_amc_tax_rate').val();
  		var tax_cal = (fld_amount * fld_tax_percentage) / 100;
  		
  		const sum = parseFloat(fld_amount) + parseFloat(tax_cal);
  		$("#fld_amc_total_amount").val(sum);
