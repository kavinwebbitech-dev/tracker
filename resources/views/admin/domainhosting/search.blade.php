    ...
    <tr>
        ...
        <td>
            <p style="display: flex;margin-bottom: 5px;margin-top: 5px;">
                ...
                <a href="javascript:void(0);" onclick="deleteProject('{{ route('admin.domain.hosting.delete', $value->id) }}')" title="Delete" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
            </p>
        </td>
    </tr>
    @endforeach
