            ...
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="box">
                            <!-- /.box-header -->
                            <form class="form" action="{{ route('admin.domain.hosting.store') }}" method="post"
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($hostingServers as $server)
                                                            <option value="{{ $server->fld_hosting_name }}"
                                                                {{ old('fld_hosting_name') == $server->fld_hosting_name ? 'selected' : '' }}>
