                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" onclick="deleteProject('{{ route('admin.service.delete', $value->id) }}')" class="creative-btn-action action-delete" style="padding: 4px 12px;margin: 0px 4px;"><i class="fa fa-trash-o text-white"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
