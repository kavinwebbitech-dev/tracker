...
@section('content')
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-md-6"><span class="btn btn-primary"
                                            style="float: right; cursor: pointer;"
                                            onclick="window.location='{{ route('admin.imcome.amount.view') }}'">
                                            Income
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive creative-table-wrapper">
                                    <table id="example_render"
                                        class="table table-bordered table-hover display nowrap margin-top-10 w-p100 creative-table">
                                        <thead>
                                            <tr>
                                                <th>S No</th>
                                                <th>Name</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="icon-text-wrapper">
                                                                ...
                                                                <span class="fw-semibold">
                                                                    {{ date('d-m-Y', strtotime($value->expensive_date)) }}
                                                                </span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <p style="display: flex;">
                                                                ...
                                                                <a href="javascript:void(0);" onclick="deleteProject('{{ route('admin.expenses.amount.delete', $value->id) }}')"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="category_form" action="{{ route('admin.expense.category.store') }}" method="post">
                        @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p style="display: flex;">
                                                    ...
                                                    <a href="javascript:void(0);" onclick="deleteProject('{{ route('admin.expense.category.delete', $cat->id) }}')"
    ...
    <script type="text/javascript">
        ...
        function ViewCategoryModel(ref) {
            $.ajax({
                url: '{{ route('admin.expense.category.edit') }}',
                method: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
                    id: ref
