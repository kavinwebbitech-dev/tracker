             ...
             <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('admin.freelancer.create') }}" class="btn btn-primary btn-sm add_button" style="float: right;">Add Freelancer</a>
                        </div>
                    </div>
                    <style type="text/css">
                        .add_button
                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="display: flex;">
                                        <a href="{{ route('admin.freelancer.edit', $value->id) }}" class="creative-btn-action action-edit" style="padding: 4px 12px;margin: 0px 4px;"><i class="ion ion-edit text-white"></i></a>
                                        <a href="javascript:void(0);" onclick="deleteProject('{{ route('admin.freelancer.delete', $value->id) }}')" class="creative-btn-action action-delete" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                    </p>
                                </td>
                            </tr>
                            @endforeach
