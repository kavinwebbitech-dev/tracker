    ...
    >
        ...
        <td>
            <p style="display: flex;margin-bottom: 0px;">
                ...
                <a href="{{ route('admin.freelancer.task.edit', $value->id) }}"
                    class="creative-btn-action action-edit"
                    style="padding: 4px 12px;margin: 0px 4px;">
                    <i class="ion ion-edit text-white"></i>
                </a>

                <a href="{{ route('admin.freelancer.task.details', $value->id) }}"
                    class="creative-btn-action btn-success"
                    style="padding: 4px 12px;margin: 0px 4px;">
                    <i class="ti-eye text-white"></i>
                </a>

                <a href="javascript:void(0);" onclick="deleteProject('{{ route('admin.freelancer.estimate.delete', $value->id) }}')"
