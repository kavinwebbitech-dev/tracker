                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="corp-table-card">
                            ...
                            <form action="{{ route('admin.customers.bulk.store') }}" method="post"
                                ...
                                <div class="corp-action-bar">
                                    ...
                                    <div class="corp-action-left">
                                        <div class="corp-upload-wrapper">
                                            ...
                                            <a href="<?php echo url(''); ?>/public/admin_assets/images/customer_upload.xlsx"
                                                download class="corp-sample-link">Sample File</a>
                                        </div>
                                        <button type="submit" name="submit" value="submit"
                                            class="corp-btn corp-btn-primary"
                                    ...
                                    <div class="corp-action-right">
                                        ...
                                        <div class="corp-search-box">
                                            ...
                                            <input type="text" name="text_value_search" id="text_value_search1"
                                                placeholder="Search customers..." onkeyup="TextValueSearch()">
                                        </div>
                                        ...
                                        <span class="corp-btn corp-btn-primary" data-bs-toggle="modal"
                            ...
                            <div class="creative-table-wrapper table-responsive">
                                <table id="example" class="creative-table w-100">
                                    <colgroup>
                                        <col style="width:5%">
                                        <col style="width:17%">
                                        <col style="width:18%">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="14%">Company Info</th>
                                            <th width="20%">Address Details</th>
                                        ...
                                        @if ($client_details)
                                            @foreach ($client_details as $key => $value)
                                                <tr>
                                                        ...
                                                        <div class="icon-text-wrapper">
                                                            ...
                                                            <div>
                                                                <span class="fw-bold text-dark d-block"
                                                                    style="font-size: 0.95rem;">{{ $value->fld_name }}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="icon-text-wrapper">
                                                            <div class="cell-icon icon-address"><i
                                                            ...
                                                            ?>
                                                            <span
                                                                title="{{ $value->fld_address }}">{{ $get_word }}</span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="fw-bold text-muted">{{ $value->fld_customer_gstno }}</span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="creative-action-box">
                                                            @if ($user_check)
                                                                <a href="{{ route('admin.customers.details', $value->id) }}"
                                                                    title="Client Panel Created"
                                                                    class="creative-btn-action action-user">
                                                                    <i class="ti-user"></i>
                                                                </a>
                                                            @else
                                                                <a onclick="ViewTaskModel1('{{ $value->id }}')"
                                                                    title="Create Client Panel"
                                                                    class="creative-btn-action action-user">
                                                                    <i class="ti-user"></i>
                                                                </a>
                                                            @endif
                                                            ...
                                                            <a onclick="ViewTaskModel('{{ $value->id }}')"
                                                                title="Edit" class="creative-btn-action action-edit">
                                                                <i class="ion ion-edit"></i>
                                                            </a>

                                                            <a href="javascript:void(0);"
                                                                onclick="deleteProject('{{ route('admin.customers.delete', $value->id) }}')"
                                                                title="Delete" class="creative-btn-action action-delete">
                                                                <i class="ti-trash"></i>
                                                            </a>
                                                        </div>
                                                    </td>
                                ...
                                <div class="row gy-4 align-items-center" id="seach_hide"
                                    style="margin-top: 20px; padding: 0 20px 20px 20px;">
                    ...
                    <form class="form" action="{{ route('admin.customers.store') }}" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group in-bord mb-3">
                                    <input type="text" class="form-control @error('fld_name') is-invalid @enderror"
                                        id="fld_name" name="fld_name" placeholder="Customers Name"
                                        value="{{ old('fld_name') }}" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group in-bord mb-3">
                                    <input type="email" class="form-control @error('fld_email') is-invalid @enderror"
                                        id="fld_email" name="fld_email" placeholder="Email Address"
                                        value="{{ old('fld_email') }}">
                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                </div>
                                @error('fld_email')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group in-bord mb-3">
                                    <input type="number" class="form-control @error('fld_phone') is-invalid @enderror"
                                        id="fld_phone" name="fld_phone" placeholder="Phone Number"
                                        value="{{ old('fld_phone') }}">
                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                </div>
                                @error('fld_phone')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group in-bord mb-3">
                                    <input type="text" class="form-control @error('fld_address') is-invalid @enderror"
                                        id="fld_address" name="fld_address" placeholder="Address"
                                        value="{{ old('fld_address') }}">
                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                </div>
                                @error('fld_address')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group in-bord mb-3">
                                    <input type="text"
                                        class="form-control @error('fld_company_name') is-invalid @enderror"
                                        id="fld_company_name" name="fld_company_name" placeholder="Company Name"
                                        value="{{ old('fld_company_name') }}">
                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group in-bord mb-3">
                                    <input type="text"
                                        class="form-control @error('fld_customer_gstno') is-invalid @enderror"
                                        id="fld_customer_gstno" name="fld_customer_gstno" placeholder="GST Number"
                                        value="{{ old('fld_customer_gstno') }}">
                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group in-bord mb-3">
                                    <input type="date"
                                        class="form-control @error('fld_customer_dob') is-invalid @enderror"
                                        id="fld_customer_dob" name="fld_customer_dob" placeholder="Business Name"
                                        value="{{ old('fld_customer_dob') }}">
                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                </div>
                                @error('service')
                                    <span class="invalid-feedback" role="alert">
                    ...
                    <form class="form" action="{{ route('admin.customers.user.store') }}" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Customers Name</label>
                                <div class="input-group in-bord mb-3">
                                    <input type="text" class="form-control @error('fld_name1') is-invalid @enderror"
                                        id="fld_name1" name="fld_name1" placeholder="Customers Name"
                                        value="{{ old('fld_name1') }}" required>
                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                </div>
                                @error('fld_name1')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Email Address</label>
                                <div class="input-group in-bord mb-3">
                                    <input type="email" class="form-control @error('fld_email1') is-invalid @enderror"
                                        id="fld_email1" name="fld_email1" placeholder="Email Address"
                                        value="{{ old('fld_email1') }}">
                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                </div>
                                @error('fld_email1')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Phone Number</label>
                                <div class="input-group in-bord mb-3">
                                    <input type="text" class="form-control @error('fld_phone1') is-invalid @enderror"
                                        id="fld_phone1" name="fld_phone1" placeholder="Phone Number"
                                        value="{{ old('fld_phone1') }}">
                                    <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                                </div>
                                @error('fld_phone')
                                    <span class="invalid-feedback" role="alert">
