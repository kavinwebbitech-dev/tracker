            ...
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="box">
                            <!-- /.box-header -->
                            <form class="form" action="{{ route('sub.staff.store') }}" method="post">
                                @csrf
                                <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group in-bord mb-3">
                                                    <input type="text"
                                                        ...
                                                        name="salary" placeholder="Salary" value="{{ old('salary') }}"
                                                        required>
                                    ...
                                    <div class="role-section premium-role-section">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-10" style="border-radius: 12px !important;">
