                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <a href="{{ route('sub.staff.create') }}"
                                            class="corp-btn corp-btn-primary add_button" style="float: right;">Add Staff</a>
                                    </div>
                                </div>
                                <style type="text/css">
                                    .add_button {
                                            ...
                                            @if ($sub_admin)
                                                @foreach ($sub_admin as $key => $value)
                                                    <tr>
                                                            ...
                                                            <div class="icon-text-wrapper">
                                                                ...
                                                                <div>
                                                                    <span class="fw-bold text-dark d-block"
                                                                        style="font-size: 0.95rem;">{{ $value->sub_admin->name ?? '' }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td><a href="{{ route('sub.staff.edit', $value->id) }}"
                                                                class="creative-btn-action action-edit"
                                                                style="padding: 4px 12px;margin: 0px 4px;"><i
                                                                    class="ion ion-edit text-white"></i></a> <a href="javascript:void(0);"
                                                                    onclick="deleteProject('{{ route('sub.staff.delete', $value->id) }}')"
                                                                class="creative-btn-action action-delete"
                                                                style="padding: 4px 12px;margin: 0px 4px;"><i
                                                                    class="ti-trash text-white"></i></a>
                                                            {{-- <a href="{{ route('sub.task.details', $value->id) }}" class="btn btn-success" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-eye text-white"></i></a> --}}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                        </tbody>
