			...
			<div class="row">			  
				...
				<div class="col-lg-12 col-12">
                    ...
                    @endif
					  <div class="box">
						<!-- /.box-header -->
						<form class="form" action="{{ route('admin.gsuide.store') }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="box-body">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="text" class="form-control @error('cname') is-invalid @enderror" name="cname" id="cname" placeholder="Name" value="{{ old('cname') }}" required>
											</div>
											@error('cname')
			                                    <span class="invalid-feedback" role="alert">
			                                        <strong>{{ $message }}</strong>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="email" class="form-control @error('cemail') is-invalid @enderror" name="cemail" id="cemail" placeholder="Email" value="{{ old('cemail') }}" required>
											</div>
											@error('cemail')
			                                    <span class="invalid-feedback" role="alert">
			                                        <strong>{{ $message }}</strong>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="text" class="form-control @error('ccname') is-invalid @enderror" name="ccname" id="ccname" placeholder="Company Name" value="{{ old('ccname') }}" required>
											</div>
											@error('ccname')
			                                    <span class="invalid-feedback" role="alert">
			                                        <strong>{{ $message }}</strong>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="text" class="form-control @error('number_of_mail') is-invalid @enderror" name="number_of_mail" id="number_of_mail" placeholder="Number of Emails" value="{{ old('number_of_mail') }}" onkeyup="NumberOfEmails()" required>
											</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control @error('fld_amount') is-invalid @enderror" name="fld_amount" id="fld_amount" placeholder="Amount" value="{{ old('fld_amount') }}" onkeyup="TaxCalculate()" required>
											</div>
											@error('fld_amount')
			                                    <span class="invalid-feedback" role="alert">
			                                        <strong>{{ $message }}</strong>
									...
									{{-- <div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control @error('fld_actual_amount') is-invalid @enderror" name="fld_actual_amount" id="fld_actual_amount" placeholder="Amount" value="{{ old('fld_actual_amount') }}" required>
											</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="text" class="form-control @error('fld_email_count') is-invalid @enderror" name="fld_email_count" id="fld_email_count" placeholder="email_count" value="{{ old('fld_email_count') }}" >
											</div>
								...
								{{-- <div class="row">
									<div class="col-md-8">
						                ...
						                <div class="col-12 text-center" id="dynamicTable">
						                    <div class="row mb-3">
						                        <div class="col-md-5">
						                            <input type="text" name="addmore[0][images]" class="form-control" multiple>
						                        </div>
						                        <div class="col-md-3">
