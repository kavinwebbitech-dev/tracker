...
<?php
    ...
    $total_task   = \App\Models\Project::where('customer_id', Auth::user()->cus_id)->get();
				...
				<div class="box">
	                ...
	                <div class="box-body">
	                	<div class="box no-shadow">		
											<form class="form-horizontal form-element col-12" action="{{ route('client.profile.upload', $user->id) }}" method="post" enctype="multipart/form-data">
												@csrf
					...
					<div class="box-footer">
					  <div class="row">
						...
						<div class="col-sm-4 be-1 bs-1">
						  <div class="description-block">
							<h5 class="description-header">{{ count($progress) }}</h5>
							<span class="description-text">Progress Project</span>
						  </div>
						  <!-- /.description-block -->
						</div>
						<!-- /.col -->
						<div class="col-sm-4">
						  <div class="description-block">
							...
							<span class="description-text">Complete Project</span>
						  </div>
						  <!-- /.description-block -->
						</div>
						<!-- /.col -->
