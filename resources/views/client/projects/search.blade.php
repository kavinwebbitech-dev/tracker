    ...
    <tr @if($value->bid_amount == $total_amount) style="background: #f6e2f7;" @endif>
        ...
        <td>
            <p style="display: flex;">
                ...
                <a href="{{ route('client.projects.edit', $value->id) }}" class="btn btn-primary" style="padding: 4px 12px;margin: 0px 4px;"><i class="ion ion-edit text-white"></i></a>
                <a href="javascript:void(0);"onclick="deleteProject('{{ route('client.projects.delete', $value->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
            </p>
        </td>
    </tr>
    @endforeach
