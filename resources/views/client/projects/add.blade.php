			...
			<div class="row">			  
				...
				<div class="col-lg-12 col-12">
                    ...
                    <style type="text/css">
					  ...
					  <div class="box">
						<!-- /.box-header -->
						<form class="form" action="{{ route('client.projects.store') }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="box-body">
								...
								<div class="row">
									...
									<div class="row">
						                ...
						                <div class="col-12 text-center" id="dynamicTable">
						                    <div class="row mb-3">
						                        <div class="col-md-10">
						                        	<textarea name="addmore[0][points]" class="form-control" rows="2" style="width: 100%;">
