...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-full">
            ...
            $admin_review = \App\Models\TaskStaff::where('staff_id', Auth::user()->id)
                ->where('status', 'user_completed')
                ->get();
            $pending = \App\Models\TaskStaff::where('staff_id', Auth::user()->id)
                ->where('status', 'pending')
                ->get();
            $progress = \App\Models\TaskStaff::where('staff_id', Auth::user()->id)
                ->where('status', 'inprogress')
                ->get();
            $completed = \App\Models\TaskStaff::where('staff_id', Auth::user()->id)
                ->where('status', 'completed')
                ->get();
            $rejected = \App\Models\TaskStaff::where('staff_id', Auth::user()->id)
                ->where('status', 'rejected')
                ->get();
            $recurring = '0';
            $over_due = \App\Models\TaskStaff::where('staff_id', Auth::user()->id)
            ...
            $over_due_rer = 0;
            $total_task_rer = 0;
            $total_recurring = \App\Models\Task::where('staff_id', Auth::user()->id)
                ->where('task_type', 'recurring')
                ->get();
            $assigned_projects = \App\Models\TaskStaff::where('staff_id', Auth::user()->id)
                ->whereNotNull('project_id')
                ->distinct('project_id')
                ->count('project_id');
            $event_details = \App\Models\EventDetail::where('status', 'Active')->get();
            $my_over_budget_tasks = \App\Models\TaskStaff::where('staff_id', Auth::user()->id)
                ->get()
                ->filter(function ($ts) {
                    return $ts->is_over_budget;
                });
            // dd($event_details);
            ?>
            <style>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-12">
                                <a href="#" class="box box_color6">
                                    <div class="box-body">
                                        <span class="text-white icon-Shield-check fs-40"><span class="path1"></span><span
                            ...
                            <div class="col-lg-4 col-12">
                                <a href="#" class="box box_color2">
                                    <div class="box-body">
                                        <span class="text-white mdi mdi-ticket-confirmation fs-30"><span
                            ...
                            <div class="col-lg-4 col-12">
                                <a href="{{ route('staff.progress') }}" class="box box_color3">
                                    <div class="box-body">
                                        <span class="text-white icon-Folder fs-40"><span class="path1"></span><span
                                                class="path2"></span></span>
                                        <div class="text-white fw-600 fs-18 mb-2">Assigned Project</div>
                                        <div class="text-white fs-24 fw-800">{{ $assigned_projects }}</div>
                                    </div>
                                </a>
                            </div>
                            @if ($my_over_budget_tasks->count() > 0)
                                <div class="row mt-3">
                                    <div class="col-12">
                                        @foreach ($my_over_budget_tasks as $ts)
                                            <div class="alert alert-danger py-2" style="font-size:13px;">
                                                <i class="mdi mdi-alert"></i>
                                                You're {{ $ts->over_budget_hours }} hrs over your assigned hours on
                                                <strong>{{ $ts->staff_name }}'s</strong> task
                                                ({{ $ts->logged_total_hours }} / {{ $ts->assigned_total_hours }} hrs)
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            $incentive_details = \App\Models\Incentive::where('month', $this_month)
                            ...
                            if (count($incentive_details) > 0) {
                                ...
                                $incentive_details1 = \App\Models\Incentive::where('month', $this_month)
                            ...
                            @if (Auth::user()->role == 'Telecaller')
                                <div class="col-lg-4 col-12">
                                    <a href="{{ route('staff.incentive') }}" class="box box_color4">
                                        <div class="box-body">
                                            <span class="text-white icon-Equalizer fs-40"><span class="path1"></span><span
                                                    class="path2"></span><span class="path3"></span><span
                                                    class="path3"></span></span>
                                            <div class="text-white fw-600 fs-18 mb-2">Incentive Amount</div>
                                            <div class="text-white  fs-24 fw-800">{{ number_format($total_incentive, 2) }}
                                            </div>
                                        </div>
                                    </a>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-12">
                                <a href="{{ route('staff.progress') }}" class="box box_color5">
                                    <div class="box-body">
                                        <span class="text-white icon-Smile fs-40"><span class="path1"></span><span
                                                class="path2"></span></span>
                            ...
                            <div class="col-lg-4 col-12">
                                <a href="{{ route('staff.completed') }}" class="box bg-info bg-hover-info">
                                    <div class="box-body">
                                        <span class="text-white icon-Chart-line fs-40"><span class="path1"></span><span
                                                class="path2"></span></span>
                            ...
                            <div class="col-lg-4 col-12">
                                <a href="{{ route('staff.closed') }}" class="box bg-warning bg-hover-warning">
                                    <div class="box-body">
                                        <span class="text-white icon-Money fs-40"><span class="path1"></span><span
                                                class="path2"></span></span>
                            ...
                            <div class="col-lg-4 col-12">
                                <a href="{{ route('staff.rejected') }}" class="box box_color4">
                                    <div class="box-body">
                                        <span class="text-white icon-Attachment1 fs-40"><span class="path1"></span><span
                                                class="path2"></span><span class="path3"></span><span
                    ...
                    if ($today_project) {
                        foreach ($today_project as $key => $value) {
                            ...
                            $today_order_amount += is_numeric($value->bid_amount) ? (float) $value->bid_amount : 0;
                    ...
                    if ($month_project) {
                        foreach ($month_project as $key1 => $value1) {
                            ...
                            $month_order_amount += is_numeric($value1->bid_amount) ? (float) $value1->bid_amount : 0;
                        ...
                        @if ($month_receive_amount)
                            @if (Auth::user()->role == 'Telecaller')
                                        ...
                                        <div class="form-group">
                                            <div class="input-group in-bord mb-3">
                                                <input type="date"
                                                    ...
                                                    onfocus="'showPicker' in this && this.showPicker()" value="">
                                            </div>
                                            @error('start_date')
                                ...
                                <a class="box box_color1">
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="text-white fw-600 fs-14 col-md-6 col-6">Today Order Value
                                                ({{ date('d-m-Y') }})</div>
                                            ...
                                            @if ($start_date || $salesperson1 || $end_date)
                                                @if ($start_date)
                                                    <div class="text-white fw-600 fs-14 col-md-6 col-6">
                                                        {{ date('d-m-Y', strtotime($start_date)) }} to
                                                        {{ date('d-m-Y', strtotime($end_date)) }} Order Value</div>
                                                    <div class="text-white text-end fs-16 fw-800 col-md-6 col-6">
                                                    ...
                                                    <div class="text-white fw-600 fs-14 col-md-6 col-6">
                                                        {{ date('d-m-Y', strtotime($start_date)) }} to
                                                        {{ date('d-m-Y', strtotime($end_date)) }} Received Amount</div>
                                                    <div class="text-white text-end fs-16 fw-800 col-md-6 col-6">
                                                    ...
                                                    <div class="text-white fw-600 fs-14 col-md-6 col-6">
                                                        {{ date('d-m-Y', strtotime($start_date)) }} to
                                                        {{ date('d-m-Y', strtotime($end_date)) }} Cancel Amount</div>
                                                    <div class="text-white text-end fs-16 fw-800 col-md-6 col-6">
                                                        {{ number_format($month_cancel_amount, 2) }}
                                                    </div>
                                                @else
                                                    <div class="text-white fw-600 fs-14 col-md-6 col-6">Total Order Value
                                                    </div>
                                                    <div class="text-white text-end fs-16 fw-800 col-md-6 col-6">
                                                        {{ number_format($month_order_amount, 2) }}
                                                    </div>
                                                    <hr>
                                                    <div class="text-white fw-600 fs-14 col-md-6 col-6">This Month Received
                                                        Amount</div>
                                                    <div class="text-white text-end fs-16 fw-800 col-md-6 col-6">
                                                        {{ number_format($month_receive_amount, 2) }}
                                                    </div>
                                                    <hr>
                                                    <div class="text-white fw-600 fs-14 col-md-6 col-6">This Month Cancel
                                                        Amount</div>
                                                    <div class="text-white text-end fs-16 fw-800 col-md-6 col-6">
                                                        {{ number_format($month_cancel_amount, 2) }}
                                                    </div>
                                            ...
                                            <div class="col-lg-12 box bg-warning bg-hover-warning" style="padding: 10px;">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="img-align">
                                                            <img
                                                                src="{{ url('/') }}/public/event_image/{{ $event->event_image }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
