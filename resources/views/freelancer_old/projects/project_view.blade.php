                                      ...
                                      aria-multiselectable="true" role="tablist">
                                        ...
                                        <div class="panel">
                                          <div class="panel-heading" id="question-{{ $key + 1}}" role="tab">
                                            <a class="panel-title" aria-controls="answer-{{ $key + 1}}" aria-expanded="false" data-bs-toggle="collapse"  href="#answer-{{ $key + 1}}" data-parent="#accordion2">
                                                {{ $user_details->name }}
                                            </a>
                                          </div>
                                          <div class="panel-collapse collapse" id="answer-{{ $key + 1}}" aria-labelledby="question-{{ $key + 1}}" role="tabpanel" data-bs-parent="#category-1">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            {{ $task->task_details->name }} ({{ $task->task_details->task_no }}) <a href="{{ route('client.task.status', $task->task_details->id) }}" class="btn btn-success" style="width: 23px;height: 24px;padding: 0px;border-radius: 16px;" target="_blank"><i class="ti-eye text-white" style="font-size: 10px;"></i></a>
                                                        </td>
