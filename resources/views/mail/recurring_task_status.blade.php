                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td style="font-size:13px;line-height: 18px;padding-bottom: 10px;">
                                                          {{ $task_details->name }} <span style="font-size:11px;">RT ({{ date('d-m-Y', strtotime($recurreing_task->start_date) ) }} - {{ date('d-m-Y', strtotime($recurreing_task->end_date) ) }})</span> - has been completed by {{ $name }}
                                                        </td>
                                                    </tr>
