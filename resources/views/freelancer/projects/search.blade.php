...
<tbody>
    ...
    ?>
    <tr @if($value->bid_amount == $total_amount) style="background: #f6e2f7;" @endif>
        <td>{{ $key + 1}}</td>
        <td>{{ $value->name }}</td>
        ...
        <td>
            <p style="display: flex;">
                <a href="{{ route('freelancer.projects.view.details', $value->id) }}" class="btn btn-success" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-eye text-white"></i></a>
                <a href="{{ route('freelancer.projects.edit', $value->id) }}" class="btn btn-primary" style="padding: 4px 12px;margin: 0px 4px;"><i class="ion ion-edit text-white"></i></a>
               <a href="javascript:void(0);"onclick="deleteProject('{{ route('freelancer.projects.delete', $value->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
            </p>
        </td>
    </tr>
    @endforeach
