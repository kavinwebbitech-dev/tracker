                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="display: flex;">
                                        @if(in_array('31', $role_section))
                                        <a href="{{ route('staff.gsuide.edit1', $value->id) }}" type="Edit" class="btn btn-success" style="padding: 4px 12px;margin: 0px 4px;"><i class="ion ion-edit text-white"></i></a>
                                        @endif
                                        @if(in_array('34', $role_section))
                                        <a href="{{ route('staff.gsuide.not.interest', $value->id) }}" data-confirm="Are you Sure Move Not Interest?" title="Not interest" class="delete btn btn-warning" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-unlink text-white"></i></a>
                                        @endif
                                        @if(in_array('32', $role_section))
                                        <a href="javascript:void(0);"onclick="deleteProject('{{ route('staff.gsuide.delete', $value->id) }}')" title="Delete" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                        @endif
                                        @if(in_array('33', $role_section))
                                        <a href="{{ route('staff.gsuide.invoice', $value->id) }}" title="Invoice" class="btn btn-dark" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-files text-white"></i></a>
                                        @endif
