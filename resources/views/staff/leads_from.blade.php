...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <form action="{{ route('staff.leads.from.bulk.upload') }}" method="post"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (in_array('70', $role_section))
                                                                <a href="javascript:void(0);"onclick="deleteProject('{{ route('staff.leads.from.delete', $value->id) }}')"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{ route('staff.leads.from.store') }}" method="post">
                        @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{ route('staff.leads.from.report') }}" method="post">
                        @csrf
    ...
    <script type="text/javascript">
        function ViewTaskModel(ref) {
            ...
            // alert(ele);
            $.ajax({
                url: '{{ route('staff.leads.from.edit') }}',
                method: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
                    id: ele
        ...
        function sort_book() {
            var expert_search_url = "{{ route('staff.leads.from.view') }}"; // confirm exact route name
            var start_date = $("#start_date").val() || "";
            var end_date = $("#end_date").val() || "";
            var service = $("#service_search").val() || "";
            var status = $("#status_id").val() || "";
            var str = "&start_date=" + start_date + "&end_date=" + end_date + "&status=" + status + "&service=" + service;
