                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p style="display: flex;margin: auto;">
                                                                       ...
                                                                       <a href="javascript:void(0);"onclick="deleteProject('{{ route('staff.domment.delete', $value->id) }}')" class="btn btn-danger" style="padding: 2px 6px;margin: 0px 1px;"><i class="ti-trash text-white"></i></a>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            @endforeach
