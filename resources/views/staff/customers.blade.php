...
<!-- Content Wrapper. Contains page content -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);"onclick="deleteProject('{{ route('staff.customers.delete', $value->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="form" action="{{ route('staff.customers.store') }}" method="post">
            @csrf
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="input-group in-bord mb-3">
                        <input type="text" class="form-control @error('fld_company_name') is-invalid @enderror" id="fld_company_name" name="fld_company_name" placeholder="Company Name" value="{{ old('fld_company_name') }}" required>
                        <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                    </div>
  ...
  <script type="text/javascript">
    function ViewTaskModel(ref) {
        ...
        // alert(ele);
        $.ajax({
            url: '{{ route('staff.customers.edit') }}',
            method: "POST",
            data: {
                _token: '{{ csrf_token() }}', 
                id: ele
