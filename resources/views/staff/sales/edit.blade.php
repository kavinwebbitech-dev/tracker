			...
			<div class="row">			  
				...
				<div class="col-lg-6 col-12">
                    ...
                    @endif
					  <div class="box">
						<!-- /.box-header -->
						<form class="form" action="{{ route('staff.sales.update', $sub_admin->id) }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="box-body">
