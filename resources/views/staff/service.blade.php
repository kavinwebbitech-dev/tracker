                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                    @if(in_array('20', $role_section))
                                    <a href="javascript:void(0);"onclick="deleteProject('{{ route('staff.service.delete', $value->id) }}')" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="fa fa-trash-o text-white"></i></a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="form" action="{{ route('staff.service.store') }}" method="post">
            @csrf
