...
@section('content')
                ...
                <div class="d-flex align-items-center">
                    <div class="me-auto">
                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('staff.index') }}"><i
                    ...
                    <div class="col-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                @if (in_array('704', $role_section))
                                    <form action="{{ route('staff.leads.whatsapp.bulk.upload') }}" method="post"
                                ...
                                <div class="row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-md-1">
                                        <a href="" id="excel_download_url" class="btn btn-success"
                                                    ...
                                                    @foreach ($leads_from as $key => $value)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @endif
                                                                @if (in_array('703', $role_section))
                                                                   <a href="javascript:void(0);"onclick="deleteProject('{{ route('staff.leads.whatsapp.delete', $value->id) }}')"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" action="{{ route('staff.leads.whatsapp.store') }}" method="post">
                        @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form" action="{{ route('staff.leads.whatsapp.bulk.report') }}" method="post">
                        @csrf
    ...
    {{-- Hidden bulk forms --}}
    <form id="bulkDeleteForm" action="{{ route('staff.leads.whatsapp.bulk.delete') }}" method="post"
        style="display:none;">
        @csrf
        <div id="bulkDeleteIds"></div>
    </form>

    <form id="bulkSendForm" action="{{ route('staff.leads.whatsapp.bulk.send') }}" method="post"
        style="display:none;">
        @csrf
    ...
    <script type="text/javascript">
        ...
        function ViewTaskModel(ref) {
            $.ajax({
                url: '{{ route('staff.leads.whatsapp.edit') }}',
                method: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
                    id: ref
        ...
        function sort_book() {
            var expert_search_url = "{{ route('staff.leads.whatsapp.view') }}";
        ...
        function ExcelDownload() {
            var expert_search_url = "{{ route('staff.leads.whatsapp.download') }}";
            var start_date = $("#start_date").val() || "";
            var end_date = $("#end_date").val() || "";
            var service = $("#service_search").val() || "";
            var str = "&start_date=" + start_date + "&end_date=" + end_date + "&service=" + service;
            $('#excel_download_url').attr('href', expert_search_url + '?' + str);
        }

        ExcelDownload(); // set href with current filters on page load
    </script>
@endsection
