                    ...
                    <div class="row gy-3 align-items-center">
                        <div class="col-12 order-0 order-md-0 col-md-6">
                            <div class="logo text-center text-md-start">
                                <a href="{{ route('client.index') }}"><img src="<?php echo url('');?>/public/admin_assets/images/logo.png" alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                                ...
                                <div class="offcanvas-header">
                                    <h5 class="offcanvas-title" id="offcanvasExampleLabel">
                                        <a href="{{ route('client.index') }}" class="logo"><img src="<?php echo url('');?>/public/admin_assets/images/logo.png" /></a>
                                    </h5>
                                ...
                                <div class="offcanvas-body mean-container">
                                    <div class="main-menu ">
                                        <nav class="mean-menulist">
                                            <ul>
                                                <li>
                                                    <a class=" active" href="{{ route('client.index') }}"><i class="bi bi-grid-fill"></i>Dashboard</a>
                                                </li>

                                                {{-- <li>
                                                    <a href="#" role="button">
                                                        <i class="bi bi-stickies-fill"></i> Project
                                                    </a>
                                                    <ul>
                                                        <li><a href="{{ route('client.projects.view') }}"><i class="bi bi-indent"></i>Domain Hosting</a></li>
                                                        <li><a href="{{ route('client.projects.create') }}"><i class="bi bi-indent"></i>Create Task</a></li>
                                                        <li><a href="{{ route('client.projects.task.view') }}"><i class="bi bi-indent"></i>View Task</a></li>
                                                    </ul>
                                                </li> --}}

                                                <li>
                                                    <a class=" active" href="{{ route('client.projects.task.view') }}"><i class="bi bi-ubuntu"></i>Task Estimate</a>
                                                </li>
            ...
            <header class="main-header web-view">
                <nav class="navbar navbar-expand-lg bg-body-tertiary">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="{{ route('client.index') }}"><img src="<?php echo url('');?>/public/admin_assets/images/logo.png" alt=""></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="{{ route('client.index') }}"><i
                                ...
                                {{-- <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('client.projects.view') }}"><i class="bi bi-indent"></i>View Projects</a></li>
                                    </ul>
                                </li> --}}

                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="{{ route('client.projects.task.view') }}"><i
                                ...
                                {{-- <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('client.projects.view') }}"><i class="bi bi-indent"></i>View Projects</a></li>
                                        <li><a class="dropdown-item" href="{{ route('client.projects.create') }}"><i class="bi bi-indent"></i> Create Task</a></li>
                                        <li><a class="dropdown-item" href="{{ route('client.projects.task.view') }}"><i class="bi bi-indent"></i> Task Estimate</a></li>
                                    </ul>
                                </li> --}}
