                            ...
                            <div class="offcanvas-body mean-container">
                                <div class="main-menu ">
                                    <nav class="mean-menulist">
                                        <ul>
                                            <li>
                                                <a class=" active" href="{{ route('staff.index') }}"><i
                                            ...
                                            @if (in_array('1', $role_section))
                                                <li>
                                                    ...
                                                    <ul>
                                                        @if (in_array('1', $role_section))
                                                            <li><a href="{{ route('staff.customers.view') }}"><i
                                                                        class="bi bi-indent"></i>Customer List</a></li>
                                                        @endif
                                                        @if (in_array('5', $role_section))
                                                            <li><a href="{{ route('staff.branches.view') }}"><i
                                                                        class="bi bi-indent"></i>Branches</a></li>
                                                        @endif
                                                        @if (in_array('13', $role_section))
                                                            <li><a href="{{ route('staff.sales.view') }}"><i
                                                                        class="bi bi-indent"></i>Sales User</a>
                                                        @endif
                                                        @if (in_array('17', $role_section))
                                                            <li><a href="{{ route('staff.service.view') }}"><i
                                                                        class="bi bi-indent"></i>Service</a>
                                                        @endif
                                                    </ul>
                                                </li>
                                            @endif
                                            @if (in_array('21', $role_section))
                                                <li>
                                                    ...
                                                    <ul>
                                                        @if (in_array('21', $role_section))
                                                            <li><a href="{{ route('staff.domain.hosting.view') }}"><i
                                                                        class="bi bi-indent"></i>Domain Hosting</a></li>
                                                        @endif
                                                        @if (in_array('29', $role_section))
                                                            <li><a href="{{ route('staff.gsuide.view') }}"><i
                                                                        class="bi bi-indent"></i>Gsuite</a></li>
                                                        @endif
                                                        @if (in_array('37', $role_section))
                                                            <li><a href="{{ route('staff.amc.view') }}"><i
                                                                        class="bi bi-indent"></i>AMC</a></li>
                                                        @endif
                                                        @if (in_array('26', $role_section))
                                                            <li><a
                                                                    href="{{ route('staff.domain.hosting.view.interest') }}"><i
                                                                        class="bi bi-indent"></i>Not Interested DH</a>
                                                            </li>
                                                        @endif
                                                        @if (in_array('42', $role_section))
                                                            <li><a href="{{ route('staff.amc.view.interest') }}"><i
                                                                        class="bi bi-indent"></i>Not Interested AMC</a>
                                                            </li>
                                                        @endif
                                                        @if (in_array('34', $role_section))
                                                            <li><a href="{{ route('staff.gsuide.view.interest') }}"><i
                                                                        class="bi bi-indent"></i>Not Interested
                                                                    Gsuite</a></li>
                                                        @endif
                                                    </ul>
                                                </li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li><a href="{{ route('staff.task.create') }}"><i
                                                                class="bi bi-indent"></i>Create Task</a></li>
                                                    <li><a href="{{ route('staff.progress') }}"><i
                                                                class="bi bi-indent"></i>Progress Task</a></li>
                                                    <li><a href="{{ route('staff.completed') }}"><i
                                                                class="bi bi-indent"></i>Completed Task</a></li>
                                                    <li><a href="{{ route('staff.closed') }}"><i
                                                                class="bi bi-indent"></i>Closed Task</a></li>
                                                    <li><a href="{{ route('staff.rejected') }}"><i
                                                                class="bi bi-indent"></i>Rejected Task</a></li>
                                                    <li><a href="{{ route('staff.over_due') }}"><i
                                                                class="bi bi-indent"></i>Over Due Task</a></li>
                                                    @if (in_array('72', $role_section))
                                                        <li><a href="{{ route('staff.follow.up.project') }}"><i
                                                                    class="bi bi-indent"></i>Follow Up Project</a></li>
                                                    @endif
                                                    @if (in_array('73', $role_section))
                                                        <li><a href="{{ route('staff.follow.up.project.payment') }}"><i
                                                                    class="bi bi-indent"></i>Follow Up Payment</a></li>
                                                    @endif
                                                </ul>
                                            </li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        @if (in_array('64', $role_section))
                                                            <li><a href="{{ route('staff.proposal.create') }}"><i
                                                                        class="bi bi-indent"></i>Add Proposal</a></li>
                                                        @endif
                                                        @if (in_array('63', $role_section))
                                                            <li><a href="{{ route('staff.proposal.view') }}"><i
                                            ...
                                            @if (in_array('67', $role_section))
                                                <li><a href="{{ route('staff.leads.from.view') }}"><i
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    @if ($notification)
                                        ...
                                        @endforeach
                                    @endif
                                    <li><a class="dropdown-item" href="{{ route('notification.view') }}">View all</a>
                                    </li>
                                </ul>
                            </div>
        ...
        <header class="main-header web-view">
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container-fluid">
                    <a class="navbar-brand" href="{{ route('staff.index') }}"><img
                            src="<?php echo url(''); ?>/public/admin_assets/images/logo.png" alt=""></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                            ...
                            @if (in_array('1', $role_section) ||
                                    in_array('5', $role_section) ||
                                    in_array('13', $role_section) ||
                                    in_array('17', $role_section) ||
                                    in_array('67', $role_section))
                                    ...
                                    <ul class="dropdown-menu">
                                        @if (in_array('1', $role_section))
                                            <li><a class="dropdown-item"
                                                    href="{{ route('staff.customers.view') }}"><i
                                                        class="bi bi-indent"></i>Customer List</a></li>
                                        @endif
                                        @if (in_array('5', $role_section))
                                            <li><a class="dropdown-item" href="{{ route('staff.branches.view') }}"><i
                                                        class="bi bi-indent"></i>Branches</a></li>
                                        @endif
                                        @if (in_array('13', $role_section))
                                            <li><a class="dropdown-item" href="{{ route('staff.sales.view') }}"><i
                                                        class="bi bi-indent"></i>Sales User</a>
                                        @endif
                                        @if (in_array('17', $role_section))
                                            <li><a class="dropdown-item" href="{{ route('staff.service.view') }}"><i
                                                        class="bi bi-indent"></i>Service</a>
                                        @endif
                            ...
                            @if (in_array('21', $role_section))
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        @if (in_array('21', $role_section))
                                            <li><a href="{{ route('staff.domain.hosting.view') }}"
                                                    class="dropdown-item"><i class="bi bi-indent"></i>Domain
                                                    Hosting</a></li>
                                        @endif
                                        @if (in_array('29', $role_section))
                                            <li><a href="{{ route('staff.gsuide.view') }}" class="dropdown-item"><i
                                                        class="bi bi-indent"></i>Gsuite</a>
                                            </li>
                                        @endif
                                        @if (in_array('37', $role_section))
                                            <li><a href="{{ route('staff.amc.view') }}" class="dropdown-item"><i
                                                        class="bi bi-indent"></i>AMC</a>
                                            </li>
                                        @endif
                                        @if (in_array('26', $role_section))
                                            <li><a href="{{ route('staff.domain.hosting.view.interest') }}"
                                                    class="dropdown-item"><i class="bi bi-indent"></i>Not Interested
                                                    DH</a></li>
                                        @endif
                                        @if (in_array('42', $role_section))
                                            <li><a href="{{ route('staff.amc.view.interest') }}"
                                                    class="dropdown-item"><i class="bi bi-indent"></i>Not Interested
                                                    AMC</a></li>
                                        @endif
                                        @if (in_array('34', $role_section))
                                            <li><a href="{{ route('staff.gsuide.view.interest') }}"
                                                    class="dropdown-item"><i class="bi bi-indent"></i>Not Interested
                                                    Gsuite</a>
                                            </li>
                                        @endif
                            ...
                            @if (in_array('45', $role_section))
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        @if (in_array('46', $role_section))
                                            <li><a href="{{ route('staff.projects.create') }}"
                                                    class="dropdown-item"><i class="bi bi-indent"></i>Add Projects</a>
                                            </li>
                                        @endif
                                        @if (in_array('45', $role_section))
                                            <li><a href="{{ route('staff.projects.view') }}" class="dropdown-item"><i
                                                        class="bi bi-indent"></i>View Projects</a></li>
                                        @endif
                                        @if (in_array('49', $role_section))
                                            <li><a href="{{ route('staff.projects.going') }}"
                                                    class="dropdown-item"><i class="bi bi-indent"></i>On Progress
                                                    Projects</a></li>
                                        @endif
                                        @if (in_array('50', $role_section))
                                            <li><a href="{{ route('staff.projects.pending') }}"
                                                    class="dropdown-item"><i class="bi bi-indent"></i>Pending
                                                    Projects</a></li>
                                        @endif
                                        @if (in_array('51', $role_section))
                                            <li><a href="{{ route('staff.projects.hold') }}" class="dropdown-item"><i
                                                        class="bi bi-indent"></i>On Hold Projects</a></li>
                                        @endif
                                        @if (in_array('52', $role_section))
                                            <li><a href="{{ route('staff.projects.completed') }}"
                                                    class="dropdown-item"><i class="bi bi-indent"></i>Completed
                                                    Projects</a></li>
                                        @endif
                                        @if (in_array('53', $role_section))
                                            <li><a href="{{ route('staff.projects.renewal') }}"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('staff.task.create') }}"><i
                                                class="bi bi-indent"></i>Create Task</a></li>
                                    <li><a class="dropdown-item" href="{{ route('staff.progress') }}"><i
                                                class="bi bi-indent"></i>Progress Task</a></li>
                                    <li><a class="dropdown-item" href="{{ route('staff.completed') }}"><i
                                                class="bi bi-indent"></i>Completed Task</a></li>
                                    <li><a class="dropdown-item" href="{{ route('staff.closed') }}"><i
                                                class="bi bi-indent"></i>Closed Task</a></li>
                                    <li><a class="dropdown-item" href="{{ route('staff.rejected') }}"><i
                                                class="bi bi-indent"></i>Rejected Task</a></li>
                                    <li><a class="dropdown-item" href="{{ route('staff.over_due') }}"><i
                                                class="bi bi-indent"></i>Over Due Task</a></li>
                                    @if (in_array('72', $role_section))
                                        <li><a class="dropdown-item" href="{{ route('staff.follow.up.project') }}"><i
                                                    class="bi bi-indent"></i>Follow Up Project</a></li>
                                    @endif
                                    @if (in_array('73', $role_section))
                                        <li><a class="dropdown-item"
                                                href="{{ route('staff.follow.up.project.payment') }}"><i
                                                    class="bi bi-indent"></i>Follow Up Payment</a></li>
                                    @endif
                                </ul>
                            </li>
                            @if (in_array('63', $role_section))
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        @if (in_array('64', $role_section))
                                            <li><a class="dropdown-item"
                                                    href="{{ route('staff.proposal.create') }}"><i
                                                        class="bi bi-indent"></i>Add Proposal</a></li>
                                        @endif
                                        @if (in_array('63', $role_section))
                                            <li><a class="dropdown-item" href="{{ route('staff.proposal.view') }}"><i
                                                        class="bi bi-indent"></i>View Proposal</a></li>
                                        @endif
                                    </ul>
                                </li>
                            ...
                            @if (in_array('67', $role_section))
                                <li class="nav-item">
                                    <a class="nav-link" aria-current="page"
                                        href="{{ route('staff.leads.from.view') }}"><i
                                            class="bi bi-file-earmark-plus-fill"></i>Leads From</a>
                                </li>
                            @endif
                            @if (in_array('701', $role_section))
                                <li class="nav-item">
                                    <a class="nav-link" aria-current="page"
                                        href="{{ route('staff.leads.whatsapp.view') }}"><i
                                            class="bi bi-whatsapp"></i></i>Leads whatsapp</a>
                                </li>
                            @endif
                        </ul>
                        <div class="d-flex">
