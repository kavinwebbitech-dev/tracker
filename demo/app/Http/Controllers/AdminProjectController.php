...
class AdminProjectController extends Controller
{
    ...
    public function view()
    {
        ...
        $recordCount = 0;
        $page_title = "Total";
        return view('admin.projects.view', compact('users', 'start_date', 'end_date', 'status','page_title', 'recordCount', 'salesperson','salesperson1','service_get1', 'service_get', 'user_title_name'));
    }
