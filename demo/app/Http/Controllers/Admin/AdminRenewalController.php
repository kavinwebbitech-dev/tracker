...
class AdminRenewalController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('sub_admin.domainhosting.add', compact('branches', 'customers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('sub_admin.domainhosting.edit', compact('branches', 'customers', 'domainhosting', 'customer_details'));
    }
