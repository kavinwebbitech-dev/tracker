...
<!-- Content Wrapper. Contains page content -->
          ...
          <div class="row">
            ...
            <div class="col-12">
             ...
             <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{ route('admin.leads.from.bulk.upload') }}" method="post" enctype="multipart/form-data">
                    @csrf
                </form>
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="input-group in-bord mb-3">
                                    <input type="date" class="form-control @error('start_date') is-invalid @enderror" id="start_date" onfocus="'showPicker' in this && this.showPicker()" name="start_date" placeholder="Business Name" value="{{ $start_date }}">
                                </div>
                                @error('start_date')
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="input-group in-bord mb-3">
                                    <input type="date" class="form-control @error('end_date') is-invalid @enderror" id="end_date" onfocus="'showPicker' in this && this.showPicker()" name="end_date" placeholder="Business Name" value="{{ $end_date }}">
                                </div>
                                @error('end_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.expenses.amount.delete', $value->id) }}" class="btn btn-danger" style="padding: 4px 12px;margin: 10px 4px;"><i class="ti-trash text-white"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="{{ route('admin.expenses.amount.store') }}" method="post">
            @csrf
            <input type="hidden" name="conference_id" id="conference_id">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="input-group in-bord mb-3">
                            <input type="date" class="form-control @error('expensive_date') is-invalid @enderror" id="expensive_date" name="expensive_date" onfocus="'showPicker' in this && this.showPicker()" placeholder="Business Name" value="{{ old('expensive_date') }}">
                            <!-- <span class="input-group in-bord-text"><i class="ti-user"></i></span> -->
                        </div>
  ...
  <script type="text/javascript">
    function ViewTaskModel(ref) {
        ...
        // alert(ele);
        $.ajax({
            url: '{{ route('admin.expenses.amount.edit') }}',
            method: "POST",
            data: {
                _token: '{{ csrf_token() }}', 
                id: ele
    ...
    function text_value_search()
    {
        ...
        if (text_value_search) {
            $.ajax({
                url: "{{ route('admin.expenses.amount.search') }}",
                type: "POST",
                data: {
