            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input type="text" name="text_value_search" id="text_value_search" class="form-control" onkeyup="text_value_search()" style="position: absolute;width: 200px;z-index: 9999;">
                        </div>
                    </div>
                    <style type="text/css">
                        .add_button
