								...
								<div class="row">
									...
									{{-- <div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="text" class="form-control @error('fld_autual_total_amount') is-invalid @enderror" name="fld_autual_total_amount" id="fld_autual_total_amount" placeholder="Total Autual Amount" value="{{ old('fld_autual_total_amount') }}" readonly>
											</div>
