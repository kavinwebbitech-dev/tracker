            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        ...
                        {{-- <div class="col-sm-8">
                            <a class="btn btn-primary" href="{{ route('admin.gsuide.create') }}" style="float: right;">Add New</a>
                        </div> --}}
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="display: flex;">
                                        <a href="{{ route('admin.gsuide.interest', $value->id) }}" data-confirm="Are you Sure Move Interest?" title="Interest" class="delete btn btn-warning" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-link text-white"></i></a>
