             ...
             <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                <div class="input-group in-bord mb-3">
                                    <select name="service_search" class="form-control select2" id="service_search">
                                        ...
                                        @if($service_id)
                                        @foreach($service_id as $key => $value)
                                        <option value="{{ $value->id }}" @if($value->id == $service_get1) selected @endif>{{ $value->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group in-bord mb-3">
                                    <select name="salesperson" class="form-control select2" id="salesperson">
                                        ...
                                        <?php
                                            $user_details = \App\Models\User::where('id', $value1->added_by)->first();
                                        ?>
                                        <option value="{{ $value1->added_by }}" @if($value1->added_by == $salesperson1) selected @endif>{{ $user_details->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group in-bord mb-3">
                                    <select name="status_id" class="form-control select2" id="status_id">
                                        ...
                                        <option value="{{ $value2->name }}" @if($value2->name == $status) selected @endif>{{ $value2->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="col-md-1">
                            <a href="" id="image_url" class="btn btn-success" style="padding: 4px 10px;margin: 0px 2px;"><i class="fa fa-download"></i></a>
                    ...
                    <div class="table-responsive">
                      <table id="example_render" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                        ...
                        <tbody>
                            ...
                            <tr @if($value->status == "Completed") style="background: #50f90733;" @endif>
                                <td>{{ $key + 1}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.leads.from.delete', $value->id) }}" class="btn btn-danger" style="padding: 4px 12px;margin: 10px 4px;"><i class="ti-trash text-white"></i></a>
