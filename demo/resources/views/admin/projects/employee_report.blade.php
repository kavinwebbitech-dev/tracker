            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    ...
                    <div class="table-responsive">
                      <table id="example_render" class="table table-bordered table-hover display nowrap margin-top-10 w-p100" style="table-layout: fixed !important;">
                        <thead>
                            <tr>
                                <th style="text-align: center;">Date</th>
                                <th style="text-align: center;">Project</th>
                                <th style="text-align: center;">Staff Name</th>
                                <th style="text-align: center;width: 500px;">Staff Commend</th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td style="text-align: center;padding: 3px 10px;">
                                    <?php
