            ...
            <div class="col-12">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-2">
                            <a class="btn btn-danger btn-sm" href="" id="image_url1" style="width: 100%;padding: 10px">Completed Payment Projects</a>
                        </div>
                        <div class="col-md-2">
                            <a class="btn btn-danger btn-sm" href="" id="image_url2" style="width: 100%;padding: 10px;background: red !important;">Cancel Payment Projects</a>
                        </div>
                        <!-- <div class="col-md-2"></div> -->
                        <div class="col-md-2">
                            <a class="btn btn-warning btn-sm" href="" id="image_url" style="width: 100%;padding: 10px;">Report Download</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
                    ...
                    <form action="{{ route('admin.projects.year.wise.store') }}" method="post" id="year_wise_project">
                    @csrf
                    ...
                    <div class="table-responsive">
                      <table id="example_render" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                        <thead>
                            <tr>
                                <th style="width: 50px;"><input type="checkbox" name="checkAll" id="checkAll"></th>
                                <th>S No</th>
                                <th>Project</th>
                        ...
                        <tbody>
                            ...
                            <tr @if($value->status == 6) style="background: #dc3545;" @endif @if($total_penc == 0) style="background: #f6e2f7;" @endif @if($value->refunded == "refunded") style="background: #ff6464;" @endif>
                                <td><input type="checkbox" name="select_invoice[]" value="{{ $value->id }}"></td>
                                <td>{{ $key + 1}}</td>
                                <td>
                                    {{ $value->name }}
