                                        ...
                                        <tr @if($value->status == "Approved") style="background: #90EE90;" @endif>
                                            ...
                                            <td>
                                                <p style="display: flex;margin-bottom: 0px;">
                                                    ...
                                                    <a href="{{ route('admin.freelancer.details.delete', $value->id) }}" class="delete btn btn-danger" data-confirm="Are you Sure Delete this Point?" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                                </p>
                                            </td>
                                        </tr>
                                        @endforeach
  ...
  <script src="<?php echo url('');?>/public/admin_assets/js/vendors.min.js"></script>
    ...
    <script type="text/javascript">
        function TaskComments(id) {
            ...
            if (project_id) {
                $.ajax({
                    url: "{{ route('admin.freelancer.request.update') }}",
                    type: "POST",
                    data: {
                        id: project_id,
                        _token: '{{csrf_token()}}'
