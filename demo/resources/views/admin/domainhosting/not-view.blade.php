                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="display: flex;">
                                        <a href="{{ route('admin.domain.hosting.interest', $value->id) }}" data-confirm="Are you Sure Move Interest?" title="Interest" class="delete btn btn-warning" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-link text-white"></i></a>
