	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h3 class="page-title">Create Domain Hosting</h3>
			...
			<div class="row">			  
				...
				<div class="col-lg-12 col-12">
                    ...
                    @endif
					  <div class="box">
						<!-- /.box-header -->
						<form class="form" action="{{ route('admin.domain.hosting.store') }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="box-body">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="date" class="form-control @error('fld_domain_start_date') is-invalid @enderror" name="fld_domain_start_date" value="{{ old('fld_domain_start_date') }}" id="fld_domain_start_date" required>
											</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<select class="form-control select2 @error('fld_domain_tenure') is-invalid @enderror" name="fld_domain_tenure" onchange="checkDate()" id="fld_domain_tenure">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="date" class="form-control @error('fld_domain_end_date') is-invalid @enderror" name="fld_domain_end_date" value="{{ old('fld_domain_end_date') }}" id="fld_domain_end_date" required>
											</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="text" class="form-control @error('fld_hosting_name') is-invalid @enderror" name="fld_hosting_name" placeholder="Hosting Name" value="{{ old('fld_hosting_name') }}" required>
											</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="date" class="form-control @error('fld_hosting_start_date') is-invalid @enderror" name="fld_hosting_start_date" value="{{ old('fld_hosting_start_date') }}" id="fld_hosting_start_date" required>
											</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="form-label">Years</label>
											<div class="input-group in-bord mb-3">
												<select class="form-control select2 @error('fld_hosting_tenure') is-invalid @enderror" name="fld_hosting_tenure" onchange="checkDate1()" id="fld_hosting_tenure">
													<option value="">Years</option>
													<option value="1">1</option>
													<option value="2">2</option>
													<option value="3">3</option>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="date" class="form-control @error('fld_hosting_end_date') is-invalid @enderror" name="fld_hosting_end_date" value="{{ old('fld_hosting_end_date') }}" id="fld_hosting_end_date" required>
											</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group in-bord mb-3">
												<input type="text" class="form-control @error('fld_tax_percentage') is-invalid @enderror" name="fld_tax_percentage" id="fld_tax_percentage" placeholder="Tax Rate" value="{{ old('fld_tax_percentage') }}" required onkeyup="TaxCalculate()">
											</div>
