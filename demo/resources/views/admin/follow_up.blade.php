                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="display: flex;">
                                        <a href="{{ route('admin.follow.up.project', $value->id) }}" class="btn btn-success" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-eye text-white"></i></a>
                                        ...
                                        <a href="{{ route('admin.follow.up.delete', $value->id) }}" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                    </p>
                                </td>
                            </tr>
                            @endforeach
