                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p style="display: flex;">
                                                                            ...
                                                                            <a href="{{ route('task.comment.delete', $value->id) }}" data-confirm="Are you sure delete this entry?" class="delete btn btn-danger" style="padding: 2px 6px;margin: 0px 1px;width: auto;"><i class="ti-trash text-white"></i></a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                @endforeach
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" id="load_html">
            <form action="{{ route('staff.follow.up.comments.project') }}" method="post">
                @csrf
