	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h3 class="page-title">Create Task Estimate</h3>
			...
			<div class="row">			  
				...
				<div class="col-lg-12 col-12">
                    ...
                    <style type="text/css">
					  ...
					  <div class="box">
						<!-- /.box-header -->
						<form class="form" action="{{ route('admin.task.request.store') }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="box-body">
											...
											<div class="input-group in-bord mb-3">
												<select class="form-control select2 @error('client_id') is-invalid @enderror" name="client_id" id="client_id">
													...
													@foreach($client_details as $key => $value)
														<option value="{{ $value->id }}"> {{ $value->name }} ({{ $value->phone }}) @if($value->client_details->fld_company_name) - {{ $value->client_details->fld_company_name }} @endif</option>
													@endforeach
												</select>
