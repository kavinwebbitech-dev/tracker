                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col_padding">- {{ date('d-m-Y H:i:s A', strtotime($task->task_main->created_at)) }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                            ...
                            @endif
                            @if($task->sub_admin_comment)
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6 col_padding">Sub Admin Comments</div>
                                    <div class="col-md-6 col_padding">{{ $task->sub_admin_comment }}</div>
                                </div>
                            </div>
                            @endif
  ...
  <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#task_status').on('change', function () {
                ...
                if (status_value == "completed" || status_value == "rejected" || status_value == "canceled" || status_value == "hold") {
