                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{-- <a href="{{ route('task.edit', $value->id) }}" class="btn btn-primary" style="padding: 4px 12px;margin: 10px 4px;"><i class="ion ion-edit text-white"></i></a> --}} 
                                    <p style="display: flex;">
                                    @if($value->status != "completed")
                                        <a href="{{ route('admin.task.delete', $value->id) }}" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                    @endif
                                        <a href="{{ route('admin.task.status', $value->id) }}" class="btn btn-success" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-eye text-white"></i></a>
                                    </p>
                                </td>
                            </tr>
                            @endforeach
