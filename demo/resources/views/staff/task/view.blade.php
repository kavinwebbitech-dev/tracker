                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- <a href="{{ route('sub.task.edit', $value->id) }}" class="btn btn-primary" style="padding: 4px 12px;margin: 0px 4px;"><i class="ion ion-edit text-white"></i></a> --}}
                                    
                                    <a href="{{ route('staff.view.task', $value->task_id) }}" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-eye text-white"></i></a>
