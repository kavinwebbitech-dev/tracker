                ...
                <div class="box">
                    <div class="box-body">
                        <div class="row">
                            ...
                            @if($task->status == "completed" || $task->status == "reopen" || $task->status == "payment_process")
                            <!-- <ul>
                            ...
                            @else
                                @if(Auth::user()->id == $task->project_follow_up)
                                    <a href="{{ route('staff.change.coordinar.task', $task->id) }}" class="delete btn btn-primary" data-confirm="Are you Sure Completed Project Follow Up?">Project Follow Up Completed</a>
                                @else
                                    <a href="{{ route('staff.change.payment.task', $task->id) }}" class="delete btn btn-primary" data-confirm="Are you Sure Completed Payment Follow Up?">Payment Follow Up Completed</a>
                                @endif
                            @endif
                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        ?>
                                          ...
                                          @foreach($task->task_staff as $key => $staff)
                                            <li><a href="#activity{{ $key }}" data-bs-toggle="tab">{{ $staff->staff_name }}</a></li>
                                          @endforeach
                                            @if(Auth::user()->id == $task->project_follow_up)
                                            @if(isset($user_details) && $user_details)
                                            <li><a @if(Auth::user()->id == $task->project_follow_up) class="active" @endif href="#activity10" data-bs-toggle="tab">Follow Up Comment</a></li>
                                            @endif
                                            @endif
                                            ...
                                            <li><a @if(Auth::user()->id == $task->payment_follow_up) class="active" @endif href="#activity11" data-bs-toggle="tab">Payment Comment</a></li>
                                            @endif
                                            @endif
                                          @endif
                                        </ul>
                                        ...
                                        <div class="tab-content">
                                          ...
                                          <div class="tab-pane" id="activity{{ $key1 }}">       
                                                <?php
                                                            ...
                                                            <tr>
                                                                ...
                                                                {{-- <td>
                                                                    <p style="display: flex;">
                                                                        <a onclick="ViewTaskModel5('{{ $value->id }}')" class="btn btn-success" style="padding: 2px 6px;margin: 0px 1px;"><i class="ion ion-edit text-white"></i></a>
                                                                        
                                                                        @if($value->admin_comment == "")
                                                                        <a onclick='ViewTaskModel("{{$value->id}}")' class="btn btn-success" style="padding: 2px 6px;margin: 0px 1px;"><i class="ti-eye text-white"></i></a>
                                                                        @endif
                                                                    </p>
                                                                </td> --}}
                                                            </tr>
                                          ...
                                          @endforeach
                                          @if(isset($user_details) && $user_details)
                                            <div class="@if(Auth::user()->id == $task->project_follow_up) active @endif tab-pane" id="activity10">
                                                <div class="box b-1 no-shadow">
                                                    <div class="media bb-1 border-fade">

                                                        @if($user_details->profile_picture)
                                                            <img class="rounded-circle" src="<?php echo url('');?>/public/profile/{{$user_details->profile_picture}}" alt="User Avatar" style="width: 70px;">
                                          ...
                                          @endif
                                          @if(isset($user_details1) && $user_details1)
                                          <div class="@if(Auth::user()->id == $task->payment_follow_up) active @endif tab-pane" id="activity11">
    ...
    <div class="modal fade" id="modal-default2">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" id="load_html">
            <form action="{{ route('staff.follow.up.project.payment') }}" method="post">
                @csrf
                <input type="hidden" name="task_id" id="task_id" value="{{ $task->id }}">
                <input type="hidden" name="project_id" id="project_id" value="{{ $task->project_id }}">
                <div class="row">
