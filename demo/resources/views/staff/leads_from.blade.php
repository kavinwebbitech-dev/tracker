          ...
          <div class="row">
            ...
            <div class="col-12">
             ...
             <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{ route('staff.leads.from.bulk.upload') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('staff.leads.from.delete', $value->id) }}" class="btn btn-danger" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                    @endif
