...
$amc_id = $domainhosting->id;
$amc_dh_details = $domainhosting->fld_amc_dh_details;
$amc_reg_date = $domainhosting->fld_amc_reg_date;
$amc_dh_tenure = $domainhosting->fld_amc_dh_tenure;
$amc_end_date = $domainhosting->fld_amc_end_date;

// $tax_percentage = $row['fld_amc_tax_rate'];
$tax_percentage_get = $domainhosting->fld_amc_tax_rate;
$tax_percentage = ($tax_percentage_get == "") ? 0 : $tax_percentage_get; 

$amount = $domainhosting->fld_amc_amount;
$total_amount = $domainhosting->fld_amc_total_amount;
$amc_description = $domainhosting->fld_amc_description;
      ...
      <div class="cs-invoice_in" id="download_section">
        ...
        <div class="cs-invoice_head cs-mb10">
          <div class="cs-invoice_left">
            ...
            <p>              
              <span id="customer_name"><?php echo $company_name; ?></span><br>
              ...
              <span>Due Date : <?php echo date('d-m-Y', strtotime($amc_end_date)); ?></span>
            </p>
          </div>
          <div class="cs-invoice_right cs-text_right">
        ...
        <div class="cs-table cs-style1">
          <div class="cs-round_border">
            <div class="cs-table_responsive">
              <table>
                ...
                ?>
                  <tr>
                    <td class="cs-width_3">AMC Renewals</td>
                    <td class="cs-width_4"><?php echo $amc_dh_details;?></td>
                    <td class="cs-width_1"><?php echo "1"; ?></td>
         ...
         <footer class="text-center mt-4 accountNo">
          ...
          <p class="text-1">Bank Name : UNION BANK OF INDIA</p>
          <p class="text-1">Branch : THUDIYALUR </p>
          <p class="text-1">Account Name : WEBBITECH </p>
          <p class="text-1">Account Number : 335001010033895 </p>
          <p class="text-1">Ifsc Code : UBIN0533505 </p>
