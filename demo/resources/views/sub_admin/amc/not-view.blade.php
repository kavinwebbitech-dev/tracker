                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="display: flex;">
                                        @if(in_array('43', $role_section))
                                        <a href="{{ route('sub_admin.amc.interest', $value->id) }}" data-confirm="Are you Sure Move Interest?" title="Interest" class="delete btn btn-warning" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-link text-white"></i></a>
                                        @endif
