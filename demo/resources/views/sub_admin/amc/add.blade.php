			...
			<div class="row">			  
				...
				<div class="col-lg-12 col-12">
                    ...
                    @endif
					  <div class="box">
						<!-- /.box-header -->
						<form class="form" action="{{ route('sub_admin.amc.store') }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="box-body">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group mb-3">
												<input type="date" class="form-control @error('fld_amc_reg_date') is-invalid @enderror" name="fld_amc_reg_date" id="fld_amc_reg_date" value="{{ old('fld_amc_reg_date') }}" required>
											</div>
