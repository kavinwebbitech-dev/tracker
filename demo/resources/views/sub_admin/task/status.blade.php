                                          ...
                                          <div class="@if($key1 == 0) active @endif tab-pane" id="activity{{ $key1 }}">       
                                                ...
                                                <div class="box b-1 no-shadow">
                                                  <div class="media bb-1 border-fade">
                                                    @if($staff->staff_details->profile_picture)
                                                        <img class="rounded-circle" src="<?php echo url('');?>/public/profile/{{$staff->staff_details->profile_picture}}" style="width: 70px;" alt="User Avatar">
                                                    @elseif($staff->staff_details->gender == "female")
                                                ...
                                                <form action="{{ route('sub_admin.task.hours.update') }}" method="post">
                                                    @csrf
                                                    @if(in_array('93', $role_section))
                                                    <div class="row">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p style="display: flex;margin-bottom: 0px;">
                                                                            @if(in_array('93', $role_section))
                                                                            <a onclick="ViewTaskModel5('{{ $value->id }}', '{{  $value->working_hours }}')" class="btn btn-success" style="padding: 2px 6px;margin: 10px 1px;"><i class="ion ion-edit text-white"></i></a>
                                                                            @endif
                                                                            @if(in_array('94', $role_section))
                                                                            <a href="{{ route('sub_admin.task.comment.delete', $value->id) }}" data-confirm="Are you sure delete this entry?" class="delete btn btn-danger" style="padding: 2px 6px;margin: 10px 1px;width: auto;"><i class="ti-trash text-white"></i></a>
                                                                            @endif
                                                                        </p>
                                                                    </td>
                                                                </tr>
  ...
  <script type="text/javascript">
            ...
            <form action="{{ route('sub_admin.task.update.comment') }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-6" style="margin-bottom: 10px;">
                        <select class="form-control" name="staff_status1" id="staff_status1" onchange="pointsOpen()">
                    ...
                    <div class="col-md-12" id="point_en1" style="display: none;">
                        <div class="form-group">
    ...
    <script type="text/javascript">
        function pointsOpen()
        {
            ...
            var staff_status1 = $("#staff_status1").val();
