                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($value->payment_follow_up == Auth::user()->id)
                                        Payment Follow Up
                                    @endif
                                    @if($value->project_follow_up == Auth::user()->id)
                                        @if($value->payment_follow_up == Auth::user()->id) , @endif Project Follow Up
                                    @endif
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('sub_admin.follow.up.project.details', $value->id) }}" class="btn btn-success" style="margin: 5px 4px;"><i class="ti-eye text-white"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
