                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col_padding">- {{ $task->start_date }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6 col_padding">End Date</div>
                                    <div class="col-md-6 col_padding">- {{ $task->end_data }}</div>
                                </div>
                            </div>
                            ...
                            @endif
                            <form action="{{ route('sub_admin.task.details.update') }}" method="post">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 col_padding">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror" name="status" id="task_status">
                                                ...
                                                <option value="recommend_to_admin" @if($task->status == "recommend_to_admin") selected @endif>Recommend to Admin</option>
  ...
  <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#task_status').on('change', function () {
                ...
                if (status_value == "recommend_to_admin" || status_value == "rejected") {
