...
<!-- Content Wrapper. Contains page content -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('sub_admin.imcome.amount.delete', $value->id) }}" class="btn btn-danger" style="padding: 4px 12px;margin: 10px 4px;"><i class="ti-trash text-white"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="{{ route('sub_admin.imcome.amount.store') }}" method="post">
            @csrf
  ...
  <script type="text/javascript">
    function ViewTaskModel(ref) {
        ...
        // alert(ele);
        $.ajax({
            url: '{{ route('sub_admin.imcome.amount.edit') }}',
            method: "POST",
            data: {
                _token: '{{ csrf_token() }}', 
                id: ele
