                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p style="display:flex;">
                                                                    ...
                                                                    <a href="{{ route('sub_admin.projects.payment.delete', $value1->id) }}" class="delete btn btn-danger" data-confirm="Are you Sure Delete this payment?" style="padding: 4px 12px;margin: 0px 4px;width: 40px;"><i class="ti-trash"></i></a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        @endforeach
