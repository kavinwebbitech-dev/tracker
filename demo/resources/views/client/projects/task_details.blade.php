                                        ...
                                        <tr id="key-{{ $value->id }}" @if($value->status == "Approved") style="background: #9ff39f;" @endif>
                                            ...
                                            <td>
                                                <p style="display: flex;margin-bottom: 0px;">
                                                    ...
                                                    @if($task_comments1)
                                                    @else
                                                        <a href="{{ route('client.projects.task.details.delete', $value->id) }}" class="delete btn btn-danger" data-confirm="Are you Sure Delete this Point?" style="padding: 4px 12px;margin: 0px 4px;"><i class="ti-trash text-white"></i></a>
                                                    @endif
                                                </p>
                                            </td>
                                        </tr>
