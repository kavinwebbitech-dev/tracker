                                        ...
                                        <tr>
                                            ...
                                            <table style="width: 100%;margin:20px 0px;border-collapse: collapse;padding: 10px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid #d9d9d9;text-align:lefy;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">{{ date('d-m-Y h:i A', strtotime($task_details->start_date)) }}</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid #d9d9d9;text-align:lefy;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">{{ date('d-m-Y h:i A', strtotime($task_details->end_date)) }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="border: 1px solid #d9d9d9;text-align:left;padding: 12px;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">Description</td>
                                                    <td style="border: 1px solid #d9d9d9;text-align:lefy;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">{!! $task_details->description !!}</td>
                                                </tr>
                                                @if($task_details->status == "completed")
                                                <tr>
                                                    <td style="border: 1px solid #d9d9d9;text-align:left;padding: 12px;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">Status </td>
                                                    <td style="border: 1px solid #d9d9d9;text-align:lefy;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">Completed</td>
                                                </tr>
                                                @else
                                                <tr>
                                                    <td style="border: 1px solid #d9d9d9;text-align:left;padding: 12px;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">Status </td>
                                                    <td style="border: 1px solid #d9d9d9;text-align:lefy;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">Rejected</td>
                                                </tr>
                                                @endif

                                                @if($task_details->user_comments)
                                                 <tr>
                                                    <td style="border: 1px solid #d9d9d9;text-align:left;padding: 12px;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">User Comments </td>
                                                    <td style="border: 1px solid #d9d9d9;text-align:lefy;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">{{ $task_details->user_comments }}</td>
                                                </tr>
                                                @endif

                                                @if($task_details->admin_comments)
                                                 <tr>
                                                    <td style="border: 1px solid #d9d9d9;text-align:left;padding: 12px;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">Admin Comments </td>
                                                    <td style="border: 1px solid #d9d9d9;text-align:lefy;font-family:'Ubuntu', Arial,sans-serif; font-size:13px; color:#000;">{{ $task_details->admin_comments }}</td>
                                                </tr>
                                                @endif
