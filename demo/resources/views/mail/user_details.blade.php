                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 20px 30px 20px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h5 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:15px; line-height:26px; text-align:left; color:#000;font-weight: 700;padding-top: 10px;padding-bottom: 10px;">Dear {{ $name }},</td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td style="font-size:15px;line-height: 18px;padding-bottom: 10px;font-weight: bold;">
                                                          Welcome to Webbitech Family
                                                    ...
                                                    <tr>
                                                        <td style="font-size:13px;line-height: 18px;padding-bottom: 10px;">
                                                          <a href="{{ $link_url }}" style="background: #3f3a64;padding: 8px;border-radius: 10px;color: #fff;text-decoration: none;">Go to Dashboard</a>
                                                        </td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td style="font-size:13px;text-align: left;line-height: 18px;padding-bottom: 10px;">
                                                            Best regards,<br>Team Webbitech
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
