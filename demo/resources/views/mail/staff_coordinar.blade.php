                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 20px 30px 20px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h5 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:15px; line-height:26px; text-align:left; color:#000;font-weight: 700;padding-top: 10px;padding-bottom: 10px;">Hi Admin,</td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td style="font-size:13px;line-height: 18px;padding-bottom: 10px;">
                                                          {{$task_details->name }} - This task Client follow up compelted.. Please follow to Payment Process. 
                                                        </td>
                                                    </tr>
