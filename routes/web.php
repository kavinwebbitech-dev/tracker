...
use App\Http\Controllers\DomainServerController;
...
Route::group(['prefix' => 'staff'], function () {
    Route::middleware(['staff', 'auth'])->group(function () {
        ...
        Route::group(['prefix' => 'leads-from'], function () {
            ...
            Route::get('leads-whatsapp', [LeadsFromController::class, 'whatsappview'])->name('staff.leads.whatsapp.view');
            Route::post('leads-whatsapp/store', [LeadsFromController::class, 'store'])->name('staff.leads.whatsapp.store');
            Route::post('leads-whatsapp/edit', [LeadsFromController::class, 'edit'])->name('staff.leads.whatsapp.edit');
            Route::get('leads-whatsapp/delete/{id}', [LeadsFromController::class, 'delete'])->name('staff.leads.whatsapp.delete');
            Route::post('leads-whatsapp/bulk-upload', [LeadsFromController::class, 'bulk_upload'])->name('staff.leads.whatsapp.bulk.upload');
            Route::post('leads-whatsapp/bulk-delete', [LeadsFromController::class, 'bulk_delete'])->name('staff.leads.whatsapp.bulk.delete');
            Route::post('leads-whatsapp/bulk-send', [LeadsFromController::class, 'bulk_send'])->name('staff.leads.whatsapp.bulk.send');
            Route::post('leads-whatsapp/report', [LeadsFromController::class, 'whatsappReport'])->name('staff.leads.whatsapp.report');
            Route::post('leads-whatsapp/bulk-report', [LeadsFromController::class, 'whatsappbulkviewReport'])->name('staff.leads.whatsapp.bulk.report');
            Route::get('leads-whatsapp-download', [LeadsFromController::class, 'whatsappDownloadLeads'])
                ->name('staff.leads.whatsapp.download');
        });
...
Route::group(['prefix' => 'sub-admin'], function () {
    Route::middleware(['sub_admin', 'auth'])->group(function () {
        ...
        Route::group(['prefix' => 'simple-task'], function () {
            Route::controller(SimpleTaskController::class)->group(function () {
                Route::get('index', 'subindex')->name('sub_admin.simpletask.view');
                Route::get('/create', 'subcreate')->name('sub_admin.simpletask.create');
                Route::post('/store', 'substore')->name('sub_admin.simpletask.store');
                Route::get('/edit/{id}', 'subedit')->name('sub_admin.simpletask.edit');
                Route::put('/update/{id}', 'subupdate')->name('sub_admin.simpletask.update');
                Route::get('/delete/{id}', 'subdestroy')->name('sub_admin.simpletask.delete');
            });
        });

        Route::group(['prefix' => 'hosting_server'], function () {
            Route::controller(HostingServerController::class)->group(function () {
                Route::get('index', 'subindex')->name('sub_admin.hosting_server.view');
                Route::get('/create', 'subcreate')->name('sub_admin.hosting_server.create');
                Route::post('/store', 'substore')->name('sub_admin.hosting_server.store');
                Route::get('/edit/{id}', 'subedit')->name('sub_admin.hosting_server.edit');
                Route::put('/update/{id}', 'subupdate')->name('sub_admin.hosting_server.update');
                Route::get('/delete/{id}', 'subdestroy')->name('sub_admin.hosting_server.delete');
            });
        });

        Route::group(['prefix' => 'domain_server'], function () {
            Route::controller(DomainServerController::class)->group(function () {
                Route::get('index', 'index')->name('sub_admin.domain_server.view');
                Route::get('/create', 'create')->name('sub_admin.domain_server.create');
                Route::post('/store', 'store')->name('sub_admin.domain_server.store');
                Route::get('/edit/{id}', 'edit')->name('sub_admin.domain_server.edit');
                Route::put('/update/{id}', 'update')->name('sub_admin.domain_server.update');
                Route::get('/delete/{id}', 'destroy')->name('sub_admin.domain_server.delete');
            });
        });
        ...
        Route::group(['prefix' => 'leads-from'], function () {
            ...
            Route::get('leads-whatsapp', [LeadsFromController::class, 'subwhatsappview'])->name('sub_admin.leads.whatsapp.view');
            Route::post('leads-whatsapp/store', [LeadsFromController::class, 'substore'])->name('sub_admin.leads.whatsapp.store');
            Route::post('leads-whatsapp/edit', [LeadsFromController::class, 'subedit'])->name('sub_admin.leads.whatsapp.edit');
            Route::get('leads-whatsapp/delete/{id}', [LeadsFromController::class, 'subdelete'])->name('sub_admin.leads.whatsapp.delete');
            Route::post('leads-whatsapp/bulk-upload', [LeadsFromController::class, 'subbulk_upload'])->name('sub_admin.leads.whatsapp.bulk.upload');
            Route::post('leads-whatsapp/bulk-delete', [LeadsFromController::class, 'subbulk_delete'])->name('sub_admin.leads.whatsapp.bulk.delete');
            Route::post('leads-whatsapp/bulk-send', [LeadsFromController::class, 'bulk_send'])->name('sub_admin.leads.whatsapp.bulk.send');
            Route::post('leads-whatsapp/report', [LeadsFromController::class, 'subwhatsappReport'])->name('sub_admin.leads.whatsapp.report');
            Route::post('leads-whatsapp/bulk-report', [LeadsFromController::class, 'subwhatsappbulkviewReport'])->name('sub_admin.leads.whatsapp.bulk.report');
            Route::get('leads-whatsapp/download', [LeadsFromController::class, 'subwhatsappDownloadLeads'])->name('sub_admin.leads.whatsapp.download');
        });
        ...
        Route::group(['prefix' => 'expense-categories'], function () {
            Route::controller(ExpenseCategoryController::class)->group(function () {
                ...
                Route::get('/', 'SubAdminview')->name('sub_admin.expense.category.view');
                Route::get('/delete/{id}', 'SubAdmindelete')->name('sub_admin.expense.category.delete');
                Route::post('/edit', 'SubAdminedit')->name('sub_admin.expense.category.edit');
                Route::post('/store', 'SubAdminstore')->name('sub_admin.expense.category.store');
            });
        });
        ...
        Route::group(['prefix' => 'income-categories'], function () {
            Route::controller(IncomeCategoryController::class)->group(function () {
                ...
                Route::get('/', 'SubAdminview')->name('sub_admin.income.category.view');
                Route::get('/delete/{id}', 'SubAdmindelete')->name('sub_admin.income.category.delete');
                Route::post('/edit', 'SubAdminedit')->name('sub_admin.income.category.edit');
                Route::post('/store', 'SubAdminstore')->name('sub_admin.income.category.store');
            });
        });
...
Route::group(['prefix' => 'super-admin'], function () {
    Route::middleware(['super_admin', 'auth'])->group(function () {
        ...
        Route::get('/all-projects/{col}', [HomeController::class, 'allProjects'])->name('super.admin.all.projects');
        ...
        Route::group(['prefix' => 'simple-task'], function () {
            Route::controller(SimpleTaskController::class)->group(function () {
                Route::get('index', 'index')->name('admin.simpletask.view');
                Route::get('/create', 'create')->name('admin.simpletask.create');
                Route::post('/store', 'store')->name('admin.simpletask.store');
                Route::get('/edit/{id}', 'edit')->name('admin.simpletask.edit');
                Route::put('/update/{id}', 'update')->name('admin.simpletask.update');
                Route::get('/delete/{id}', 'destroy')->name('admin.simpletask.delete');
            });
        });

        Route::group(['prefix' => 'hosting_server'], function () {
            Route::controller(HostingServerController::class)->group(function () {
                Route::get('index', 'index')->name('admin.hosting_server.view');
                Route::get('/create', 'create')->name('admin.hosting_server.create');
                Route::post('/store', 'store')->name('admin.hosting_server.store');
                Route::get('/edit/{id}', 'edit')->name('admin.hosting_server.edit');
                Route::put('/update/{id}', 'update')->name('admin.hosting_server.update');
                Route::get('/delete/{id}', 'destroy')->name('admin.hosting_server.delete');
            });
        });

        Route::group(['prefix' => 'domain_server'], function () {
            Route::controller(DomainServerController::class)->group(function () {
                Route::get('index', 'index')->name('admin.domain_server.view');
                Route::get('/create', 'create')->name('admin.domain_server.create');
                Route::post('/store', 'store')->name('admin.domain_server.store');
                Route::get('/edit/{id}', 'edit')->name('admin.domain_server.edit');
                Route::put('/update/{id}', 'update')->name('admin.domain_server.update');
                Route::get('/delete/{id}', 'destroy')->name('admin.domain_server.delete');
            });
        });
        ...
        Route::group(['prefix' => 'projects'], function () {
            Route::controller(AdminProjectController::class)->group(function () {
                ...
                Route::post('/admin/project/assigned-staff', [AdminProjectController::class, 'getAssignedStaff'])->name('admin.project.assigned.staff.get');
                Route::post('/admin/project/assign-staff-hours', [AdminProjectController::class, 'assignStaffWithHours'])->name('admin.project.assign.staff.hours');
        ...
        Route::group(['prefix' => 'staff'], function () {
            Route::controller(StaffController::class)->group(function () {
                ...
                Route::get('/staff-project-view', 'staffProjectView')->name('sub.staff.project.view');
        ...
        Route::group(['prefix' => 'expense-categories'], function () {
            Route::controller(ExpenseCategoryController::class)->group(function () {
                ...
                Route::get('/', 'view')->name('admin.expense.category.view');
                Route::get('/delete/{id}', 'delete')->name('admin.expense.category.delete');
                Route::post('/edit', 'edit')->name('admin.expense.category.edit');
                Route::post('/store', 'store')->name('admin.expense.category.store');
            });
        });
        ...
        Route::group(['prefix' => 'income-categories'], function () {
            Route::controller(IncomeCategoryController::class)->group(function () {
                ...
                Route::get('/', 'view')->name('admin.income.category.view');
                Route::get('/delete/{id}', 'delete')->name('admin.income.category.delete');
                Route::post('/edit', 'edit')->name('admin.income.category.edit');
                Route::post('/store', 'store')->name('admin.income.category.store');
            });
        });
